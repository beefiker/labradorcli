...
description: View or modify Labrador application settings using the bundled JSON schema for guidance
---

# modify-settings

Use this skill when the user wants to view, change, or troubleshoot Labrador application settings.
...
If the file does not exist yet, create it. Labrador hot-reloads this file, so changes take effect immediately.
