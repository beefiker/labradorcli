...
`Labrador loses my selected theme after restart on macOS. I changed it twice and it keeps going back.`

Draft shape:

- classification: `bug`
- title: `Theme selection resets after restarting Labrador on macOS`
- missing details: Labrador version, macOS version, whether the issue reproduces every restart
