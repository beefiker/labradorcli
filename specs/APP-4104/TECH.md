...
- `crates/labrador_ui/src/platform/mac/mod.rs (29-34)` — `make_nsstring`, the existing helper that returns an autoreleased `NSString`
...
Labrador already has established patterns for temporary Cocoa strings:

- `labrador_ui::platform::mac::make_nsstring` returns an autoreleased `NSString`
...
- import `labrador_ui::platform::mac::make_nsstring` at the top of the file
