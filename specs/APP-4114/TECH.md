...
- Restart Labrador and verify restored panes keep their custom names.
...
```bash
cargo test -p labrador vertical_tabs
cargo test -p labrador persistence::sqlite_tests
cargo test -p labrador workspace::action_tests
```
