...
### Feature flags
- `crates/labrador_features/src/lib.rs:9` — `FeatureFlag` enum.
- `crates/labrador_features/src/lib.rs:797` — `DOGFOOD_FLAGS` array.
...
File: `crates/labrador_features/src/lib.rs`
...
1. Existing user launches Labrador with `HOAOnboardingFlow` enabled.
