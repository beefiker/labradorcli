use super::{
    ...
    workspace::{
        ...
        InviteLinkDomainRestriction, LabradorAiPolicy, LinkSharingSettings, LlmSettings,
        ...
        UgcDataCollectionPolicy, UsageBasedPricingPolicy, Workspace, WorkspaceInviteCode,
...
use anyhow::anyhow;
use labrador_graphql::workspace::AddonCreditsSettings as GqlAddonCreditsSettings;
use labrador_graphql::{
    billing::{
        ...
        InstanceShape as GqlInstanceShape, LabradorAiPolicy as GqlLabradorAiPolicy,
...
impl From<GqlLabradorAiPolicy> for LabradorAiPolicy {
    fn from(gql_labrador_ai_policy: GqlLabradorAiPolicy) -> LabradorAiPolicy {
        Self {
            limit: i64::from(gql_labrador_ai_policy.limit),
            is_code_suggestions_toggleable: gql_labrador_ai_policy.is_code_suggestions_toggleable,
            is_prompt_suggestions_toggleable: gql_labrador_ai_policy
                .is_prompt_suggestions_toggleable,
            is_next_command_enabled: gql_labrador_ai_policy.is_next_command_enabled,
            is_voice_enabled: gql_labrador_ai_policy.is_voice_enabled,
        }
    }
}
...
impl From<GqlTier> for Tier {
    fn from(gql_tier: GqlTier) -> Tier {
        Self {
            ...
            labrador_ai_policy: gql_tier.labrador_ai_policy.map(From::from),
...
impl From<labrador_graphql::workspace::LlmModelHost> for crate::ai::llms::LLMModelHost {
    fn from(gql_host: labrador_graphql::workspace::LlmModelHost) -> Self {
        use labrador_graphql::workspace::LlmModelHost as GqlLlmModelHost;
        match gql_host {
...
impl From<labrador_graphql::workspace::LlmHostSettings> for super::workspace::LlmHostSettings {
    fn from(gql_settings: labrador_graphql::workspace::LlmHostSettings) -> Self {
        Self {
...
impl From<labrador_graphql::workspace::LlmSettings> for LlmSettings {
    fn from(gql_settings: labrador_graphql::workspace::LlmSettings) -> Self {
...
impl From<GqlWorkspaceSettings> for WorkspaceSettings {
    fn from(gql_workspace_settings: GqlWorkspaceSettings) -> WorkspaceSettings {
        Self {
            ...
            enable_labrador_attribution: gql_workspace_settings
                .ambient_agent_settings
                .map(|s| s.enable_labrador_attribution.into())
                .unwrap_or_default(),
        }
    }
}
