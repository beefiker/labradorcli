...
impl Workspace {
    ...
    pub fn get_auto_reload_price_cents(
        &self,
        addon_credits_options: &[labrador_graphql::billing::AddonCreditsOption],
    ) -> Option<i32> {
...
pub struct Tier {
    ...
    pub labrador_ai_policy: Option<LabradorAiPolicy>,
...
impl BillingMetadata {
    ...
    // Whether the enterprise customer is the Labrador plan.
    pub fn is_labrador_plan(&self) -> bool {
        self.tier.name == "Labrador Plan"
    }
...
pub struct WorkspaceSettings {
    ...
    #[serde(default)]
    pub enable_labrador_attribution: AdminEnablementSetting,
}
