...
use crate::{
    ...
    report_error,
    server::{ids::ServerId, server_api::workspace::WorkspaceClient},
    settings::{
        AISettings, AISettingsChangedEvent, CodeSettings, CodeSettingsChangedEvent, PrivacySettings,
    },
    workspaces::workspace::{AiAutonomySettings, AiOverages, SandboxedAgentSettings},
};
use anyhow::Result;
use labrador_core::{
...
use labrador_graphql::workspace::FeatureModelChoice;
use labrador_ui::{AppContext, Entity, ModelContext, SingletonEntity, Tracked};
use regex::Regex;
use std::sync::Arc;
...
impl UserWorkspaces {
    ...
    /// are on the Labrador Plan or the build is dogfood (both our internal team and dogfood
