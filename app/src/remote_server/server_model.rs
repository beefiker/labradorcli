...
use labrador_core::SessionId;
use labrador_util::standardized_path::StandardizedPath;
use labrador_ui::platform::TerminationMode;
use labrador_ui::r#async::{Spawnable, SpawnableOutput, SpawnedFutureHandle};
...
pub struct ServerModel {
    ...
    /// per SSH session / Labrador tab connecting to this host.  Each entry maps
