//! This module contains the code path for the [`labrador_cli::Command::DumpDebugInfo`] subcommand.
//!
//! This is intended to never be used by a vast majority of users. This is only intended for users
//! who are unable to run Labrador and want to provide us, the dev team, with useful debugging
//! information.
#[cfg(not(windows))]
use command::blocking::Command;
use labrador_core::channel::ChannelState;
use labrador_ui::windowing;
...
pub(crate) fn run() -> anyhow::Result<()> {
    ...
    #[cfg(not(target_os = "macos"))]
    {
        if let Ok(event_loop) = winit::event_loop::EventLoop::new() {
            labrador_ui::rendering::wgpu::init_wgpu_instance(Box::new(
    ...
    #[cfg(any(target_os = "linux", windows))]
    {
        ...
        println!("##################################################");
        labrador_ui::r#async::block_on(labrador_ui::rendering::wgpu::print_wgpu_adapters(
