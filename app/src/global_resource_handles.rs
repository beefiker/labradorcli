...
use labrador_ui::{Entity, ModelHandle, SingletonEntity};
...
///   One example use case could be receiving updates from the Labrador config watcher
...
impl GlobalResourceHandles {
    ...
    pub fn mock(app: &mut labrador_ui::App) -> Self {
