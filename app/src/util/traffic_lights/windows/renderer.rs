...
impl WindowsTrafficLightIcon {
    ...
    fn background_hover_color(&self, theme: &LabradorTheme) -> Fill {
        match self {
    ...
    fn icon_hover_color(&self, theme: &LabradorTheme) -> ColorU {
        match self {
    ...
    fn icon_color(&self, theme: &LabradorTheme) -> ColorU {
