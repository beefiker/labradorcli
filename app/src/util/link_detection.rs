...
use labrador_ui::elements::PartialClickableElement;
...
use labrador_ui::text::char_slice;
use labrador_ui::Action;
                    ...
                    if let DetectedLinkType::FilePath { absolute_path, .. } = &path_type {
                        for (line_number, char_range) in line_ranges {
                            ...
                            let line_range_link = DetectedLinkType::FilePath {
                                ...
                                line_and_column_num: Some(labrador_util::path::LineAndColumnArg {
...
pub(crate) fn get_word_range_at_offset(
    ...
    use labrador_editor::content::buffer::{ToBufferCharOffset, ToBufferPoint};
    use labrador_ui::text::words::is_default_word_boundary;
