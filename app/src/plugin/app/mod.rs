...
use super::{LEGACY_PLUGIN_HOST_ADDRESS_ENV_VAR, PLUGIN_HOST_ADDRESS_ENV_VAR, PLUGIN_HOST_FLAG};
    ...
    pub fn new(ctx: &mut ModelContext<Self>) -> Result<Self> {
        ...
        let server_builder =
            server_builder.with_service(service_impl::RegisterCommandSignatureServiceImpl::new(
                labrador_completer::signatures::CommandRegistry::global_instance(),
            ));
