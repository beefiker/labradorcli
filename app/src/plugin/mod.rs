...
/// Flag to be passed to the Labrador executable when executing the Labrador binary as the plugin host
...
/// plugin host process.
const PLUGIN_HOST_ADDRESS_ENV_VAR: &str = "LABRADOR_PLUGIN_HOST_ADDRESS";
