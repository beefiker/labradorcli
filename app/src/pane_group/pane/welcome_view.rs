...
use labrador_ui::elements::{Align, ChildView, Container, CrossAxisAlignment, Flex, ParentElement};
use labrador_ui::keymap::EditableBinding;
use labrador_ui::platform::FilePickerConfiguration;
    ...
    fn render(&self, _app: &AppContext) -> Box<dyn Element> {
        Align::new(
            Flex::column()
                ...
                .with_children([
                    Container::new(render_labrador_icon(50., 12.))
