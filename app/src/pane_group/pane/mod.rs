...
impl PaneId {
    ...
    pub fn dummy_pane_id() -> Self {
        Self(IPaneId {
            ...
            pane_view_id: labrador_ui::EntityId::new(),
        })
    }
    ...
    /// Returns true if this pane contains a Labrador Drive object (notebook, workflow, etc.).
    pub fn is_labrador_drive_object_pane(&self) -> bool {
    ...
    pub fn render(self, app: &AppContext) -> Box<dyn Element> {
        let mut element = match self.0.pane_type {
            ...
            IPaneType::DeferredPlaceholder => labrador_ui::elements::Empty::new().finish(),
            #[cfg(test)]
            IPaneType::Dummy => labrador_ui::elements::Empty::new().finish(),
        };
