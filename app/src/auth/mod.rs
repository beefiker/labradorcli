...
use labrador_ui::modals::{AlertDialogWithCallbacks, ModalButton};

use labrador_core::{channel::ChannelState, user_preferences::GetUserPreferences as _};
...
pub fn init(_app: &mut AppContext) {
    // Local-only fork: no Labrador Cloud login UI to initialize.
}
...
pub fn maybe_log_out(app: &mut AppContext) {
            ...
            || num_unsaved_files > 0)
    {
        ...
        // we show the custom Labrador modal.
...
pub fn log_out(app: &mut AppContext) {
    ...
    crate::platform::wasm::emit_event(crate::platform::wasm::LabradorEvent::LoggedOut);
}
