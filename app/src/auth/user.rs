...
use labrador_graphql::{queries::get_user::FirebaseProfile, scalars::time::ServerTimestamp};

use super::UserUid;

pub use labrador_server_client::auth::{TEST_USER_EMAIL, TEST_USER_UID};
...
impl From<labrador_graphql::queries::get_user::PrincipalType> for PrincipalType {
    fn from(value: labrador_graphql::queries::get_user::PrincipalType) -> Self {
        use labrador_graphql::queries::get_user::PrincipalType as GqlPrincipalType;
        match value {
...
impl TryFrom<labrador_graphql::mutations::create_anonymous_user::AnonymousUserType>
    for AnonymousUserType
{
    type Error = anyhow::Error;
    fn try_from(
        value: labrador_graphql::mutations::create_anonymous_user::AnonymousUserType,
    ) -> Result<Self, Self::Error> {
        match value {
            labrador_graphql::mutations::create_anonymous_user::AnonymousUserType::NativeClientAnonymousUser => Ok(AnonymousUserType::NativeClientAnonymousUser),
            labrador_graphql::mutations::create_anonymous_user::AnonymousUserType::NativeClientAnonymousUserFeatureGated => Ok(AnonymousUserType::NativeClientAnonymousUserFeatureGated),
            labrador_graphql::mutations::create_anonymous_user::AnonymousUserType::WebClientAnonymousUser => Ok(AnonymousUserType::WebClientAnonymousUser),
            labrador_graphql::mutations::create_anonymous_user::AnonymousUserType::Other(_) => {
...
impl TryFrom<labrador_graphql::queries::get_user::AnonymousUserPersonalObjectLimits>
    for PersonalObjectLimits
{
    type Error = anyhow::Error;
    fn try_from(
        value: labrador_graphql::queries::get_user::AnonymousUserPersonalObjectLimits,
    ) -> Result<Self, Self::Error> {
        Ok(Self {
