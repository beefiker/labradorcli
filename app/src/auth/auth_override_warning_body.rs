...
const AUTH_OVERRIDE_DESCRIPTION: &str = "It looks like you logged into a Dwarf account through a web browser. If you continue, any personal Dwarf Drive objects and preferences from this anonymous session with be permanently deleted.";
...
const AUTH_OVERRIDE_CONFIRM_CONFIRMATION_STEP_HEADER: &str =
    "Delete personal Dwarf Drive objects and preferences?";
...
impl View for AuthOverrideWarningBody {
    ...
    fn accessibility_contents(&self, _: &AppContext) -> Option<AccessibilityContent> {
        Some(AccessibilityContent::new(
            "New login detected",
            "Dwarf has detected a new login from a web browser. Press escape to cancel and continue using Dwarf without login.",
