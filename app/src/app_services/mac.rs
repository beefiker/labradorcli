#[allow(deprecated)]
use cocoa::base::id;
use labrador_ui::platform::mac::make_nsstring;
...
extern "C" {
    ...
    /// application.
    fn labrador_register_services_provider();
}

/// Initializes application services.
pub fn init() {
    unsafe {
        labrador_register_services_provider();
    }
}
...
#[allow(deprecated)]
#[no_mangle]
extern "C-unwind" fn labrador_services_provider_custom_url_scheme() -> id {
