...
use labrador_core::settings::{macros::define_settings_group, SupportedPlatforms, SyncToCloud};
...
fn init_test_app(ctx: &mut labrador_ui::AppContext) {
...
fn test_migration_copies_public_settings_from_native_store() {
    labrador_ui::App::test((), |mut app| async move {
...
mod notifications_migration {
    ...
    pub fn init_notifications_migration_test_app(ctx: &mut labrador_ui::AppContext) {
        ctx.add_singleton_model(move |_| {
