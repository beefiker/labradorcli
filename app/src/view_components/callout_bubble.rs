...
use labrador_ui::ui_components::checkbox::Checkbox;
...
pub fn render_callout_bubble(
    ...
    let triangle = Stack::new()
        .with_child(
            ConstrainedBox::new(
                border_icon
                    .to_labrador_ui_icon(Fill::Solid(border_color))
                    .finish(),
            )
            .with_width(24.)
            .with_height(24.)
        ...
        .with_child(
            ConstrainedBox::new(fill_icon.to_labrador_ui_icon(background).finish())
                .with_width(24.)
                .with_height(24.)
                .finish(),
        )
