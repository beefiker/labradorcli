...
use labrador_graphql::mutations::issue_task_identity_token::{
...
use labrador_managed_secrets::client::{SecretOwner, TaskIdentityToken};

use super::ServerApi;
use crate::server::graphql::{get_request_context, get_user_facing_error_message};

pub use labrador_managed_secrets::client::{ManagedSecretConfigs, ManagedSecretsClient};
...
impl ManagedSecretsClient for ServerApi {
    ...
    async fn issue_task_identity_token(
        &self,
        options: labrador_managed_secrets::client::IdentityTokenOptions,
