// Re-export types from labrador_server_client.
pub use labrador_server_client::ids::{
...
///
/// Note: This macro uses `$crate::server::ids::*` paths, so it only works within the Labrador app crate.
/// For types defined in labrador_server_client, use `labrador_server_client::server_id_traits!` instead.
#[macro_export]
