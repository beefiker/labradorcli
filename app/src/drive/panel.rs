...
/// The sidebar that houses Dwarf Drive.
/// `DrivePanel` is different from `DriveIndex` in that it is responsible for
/// how Dwarf Drive interacts with the workspace and the rest of the app, whereas
/// `DriveIndex` is the main warp drive view and responsible for the internals of Dwarf Drive.
...
impl DrivePanel {
    ...
    /// This functions scrolls the relevant Dwarf Drive item into view.
    ...
    /// This functions sets the index of a focused Dwarf Drive item.
