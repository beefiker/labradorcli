...
const HONOR_PS1_NAME: &str = "LABRADOR_HONOR_PS1";
const INITIAL_WORKING_DIR_NAME: &str = "LABRADOR_INITIAL_WORKING_DIR";
const USE_SSH_WRAPPER_NAME: &str = "LABRADOR_USE_SSH_WRAPPER";
const SHELL_DEBUG_MODE_NAME: &str = "LABRADOR_SHELL_DEBUG_MODE";
const TERM_PROGRAM_NAME: &str = "TERM_PROGRAM";
const CLIENT_VERSION_NAME: &str = "LABRADOR_CLIENT_VERSION";
const IS_LOCAL_SESSION_NAME: &str = "LABRADOR_IS_LOCAL_SHELL_SESSION";
const SSH_SOCKET_DIR: &str = "SSH_SOCKET_DIR";
const PATH_APPEND_NAME: &str = "LABRADOR_PATH_APPEND";
...
pub(super) fn get_shell_environment_variables(options: &PtyOptions) -> Vec<u16> {
    ...
    env.insert(
        ...
        EnvEntry {
            ...
            value: format!("{}Terminal", ChannelState::app_name_display()).into(),
        },
    );
    ...
    // Set LABRADOR_PATH_APPEND with additional PATH entries to append.
