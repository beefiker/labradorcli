//! Logic relating to a secondary process which Labrador uses to spawn new shell
//! sessions.
//!
...
//! early during Labrador's initialization, we can be more confident that there are
...
pub fn run_terminal_server(args: &labrador_cli::TerminalServerArgs) {
...
/// between processes, enabling the Labrador application process to communicate
    ...
    pub fn new() -> Result<Self> {
        ...
        unsafe {
            ...
            let server = Command::new(program)
                ...
                .arg(labrador_cli::terminal_server_subcommand())
