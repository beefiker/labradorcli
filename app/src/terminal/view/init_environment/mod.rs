...
const EXPLANATION_TEXT: &str = "Would you like to create a local environment for this project? The agent will guide you through choosing repos, configuring a Docker image, and specifying startup commands.";
