...
use labrador_ui::keymap::{BindingDescription, PerPlatformKeystroke};
...
fn init_overlapping_keybindings(app: &mut AppContext) {
    ...
    app.register_fixed_bindings([
        FixedBinding::new(
            escape_key,
            TerminalAction::NotifySshErrorBlock(SshErrorBlockAction::ContinueWithoutLabradorification),
...
pub fn init(app: &mut AppContext) {
    ...
    // Register input mode bindings before labradorify bindings so ctrl-i labradorifies
    // instead of opening inline agent when a labradorify banner is visible.
    ...
    app.register_fixed_bindings([
        ...
        FixedBinding::standard(
            labrador_ui::actions::StandardAction::Paste,
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            TerminalAction::LabradorifySSHSession,
        )
        .with_key_binding("ctrl-i")
        .with_context_predicate(
            id!("Terminal")
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            "terminal:ask_ai_assistant",
            format!("Ask {} about Selection", ChannelState::app_name_ai()),
    ...
    app.register_editable_bindings([
        EditableBinding::new(
            ...
            format!("Ask {} about last block", ChannelState::app_name_ai()),
        ...
        EditableBinding::new(
            "terminal:ask_ai_assistant",
            format!("Ask {}", ChannelState::app_name_ai()),
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            "[Debug] Onboarding Callout: LabradorInput - Terminal",
            TerminalAction::OnboardingFlow(OnboardingVersion::Legacy),
        )
        .with_enabled(|| {
        ...
        EditableBinding::new(
            ...
            "[Debug] Onboarding Callout: LabradorInput - Project",
        ...
        EditableBinding::new(
            ...
            "[Debug] Onboarding Callout: LabradorInput - No Project",
            TerminalAction::OnboardingFlow(OnboardingVersion::Agent(
    ...
    app.register_editable_bindings([EditableBinding::new(
        ...
        BindingDescription::new("Initiate project for labrador"),
...
fn register_input_mode_bindings(app: &mut AppContext) {
    ...
    // Labrador agent should not be tagged into a CLI agent's command, and the
