use labrador_ui::{prelude::ChildView, Element, EntityId, View, ViewContext, ViewHandle};
...
pub enum RichContentMetadata {
    ...
    SshLabradorifyBlock {
        ssh_labradorify_block_handle: ViewHandle<SshLabradorifyBlock>,
    },
    SshInstallTmuxBlock {
    ...
    LabradorifySuccessBlock {
        bootstrap_success_block_handle: ViewHandle<LabradorifySuccessBlock>,
    },
    TelemetryBanner {
