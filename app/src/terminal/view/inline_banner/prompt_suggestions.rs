...
use labrador_ui::{elements::MouseStateHandle, Element};
use labrador_ui::{
    AppContext, Entity, EventContext, ModelHandle, TypedActionView, ViewContext, ViewHandle,
};
use labrador_ui::{SingletonEntity, View};
...
use labrador_core::ui::theme::color::internal_colors::{neutral_2, neutral_3};
...
const DELINQUENT_DUE_TO_PAYMENT_ISSUE_TOOLTIP_MESSAGE: &str = "Provider access issue";
const OUT_OF_REQUESTS_TOOLTIP_MESSAGE: &str = "Local agent unavailable";
...
fn render_button(
    ...
    let hoverable = Hoverable::new(mouse_state.clone(), |mouse_state| {
        ...
        let mut flex = Flex::row()
            ...
            .with_child(
                Container::new(render_labrador_icon(icon_size, 3.))
        ...
        inner_banner_flex.add_child(
            Shrinkable::new(
                ...
                render_button(
                    ...
                    Rc::new(move |ctx: &mut labrador_ui::EventContext<'_>| {
