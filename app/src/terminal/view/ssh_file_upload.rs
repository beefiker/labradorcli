...
use labrador_core::ui::{appearance::Appearance, color::blend::Blend as _};
use labrador_ui::{
    elements::{
...
impl TypedActionView for FileUpload {
    ...
    ) -> labrador_ui::accessibility::ActionAccessibilityContent {
        Default::default()
    }
}
...
impl FileUpload {
    ...
    /// Creates an sftp command that copies a given local file into the PWD of the labradorified ssh session, if any.
