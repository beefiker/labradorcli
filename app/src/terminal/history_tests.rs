...
use labrador_ui::{App, ModelHandle};
        ...
        App::test((), |mut app| async move {
            sandbox.with_files(vec![Stub::FileWithContentToBeTrimmed(
                ...
                r#"
                    ls
                    pwd
                    labrador --listen --ports=8080,8081
                "#,
            )]);
            ...
            history_handle.read(&app, |history, _ctx| {
                assert_eq!(
                    ...
                    vec![
                        &HistoryEntry::command_only("labrador --listen --ports=8080,8081"),
        ...
        App::test((), |mut app| async move {
            ...
            history_handle.read(&app, |history, _ctx| {
                assert_eq!(
                    history.commands(session.id()).unwrap_or_default(),
                    vec![
                        &HistoryEntry::command_only("cd labrador"),
    ...
    App::test((), |mut app| async move {
        let session_a = Arc::new(Session::new(
            SessionInfo::new_for_test()
                ...
                .with_home_dir("/users/labradoruser".to_owned()),
            Arc::new(TestCommandExecutor::default()),
        ));
