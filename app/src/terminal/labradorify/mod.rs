...
use labrador_ui::AssetProvider;

#[derive(Debug)]
pub enum LabradorificationSource {
    Ssh,
    Subshell,
}
...
/// Returns OutputGrid bytes to be rendered in the hardcoded "Labradorified subshell" block that's
/// added to the blocklist upon successful subshell bootstrap.
///
