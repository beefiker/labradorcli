...
define_settings_group!(GeneralSettings, settings: [
    ...
    open_in_labrador_banner_dismissed_for_markdown: OpenInLabradorBannerDismissedMarkdown {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    open_in_labrador_banner_dismissed_for_code_and_text: OpenInLabradorBannerDismissedCode {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Never,
    ...
    // One-time flag tracking whether the OpenLabrador launch modal has already been
    ...
    did_check_to_trigger_openlabrador_launch_modal: DidShowOpenLabradorLaunchModal {
        type: bool,
        default: false,
        supported_platforms: SupportedPlatforms::ALL,
