...
pub struct ModalSizes {
    ...
    pub labrador_ai_width: ResizableStateHandle,
    pub voltron_width: ResizableStateHandle,
    pub labrador_drive_index_width: ResizableStateHandle,
...
impl ModalSizes {
    ...
    pub fn from_restored(
        ...
        let labrador_ai_width = window_snapshot
            .labrador_ai_width
            .unwrap_or(DEFAULT_LABRADOR_AI_WIDTH);
        let voltron_width = window_snapshot
            .voltron_width
            .unwrap_or(DEFAULT_VOLTRON_WIDTH);
        let labrador_drive_index_width = window_snapshot
            .labrador_drive_index_width
            .unwrap_or(DEFAULT_LABRADOR_DRIVE_INDEX_WIDTH);
        ...
        Self {
            ...
            labrador_ai_width: resizable_state_handle(labrador_ai_width),
            voltron_width: resizable_state_handle(voltron_width),
            labrador_drive_index_width: resizable_state_handle(labrador_drive_index_width),
    ...
    pub fn default_with_panel_defaults(left_default: f32, right_default: f32) -> Self {
        ModalSizes {
            ...
            labrador_ai_width: resizable_state_handle(DEFAULT_LABRADOR_AI_WIDTH),
            voltron_width: resizable_state_handle(DEFAULT_VOLTRON_WIDTH),
            labrador_drive_index_width: resizable_state_handle(DEFAULT_LABRADOR_DRIVE_INDEX_WIDTH),
    ...
    pub fn get_resizable_state_handle(&self, modal: ModalType) -> ResizableStateHandle {
        match modal {
            ...
            ModalType::LabradorAIWidth => self.labrador_ai_width.clone(),
            ModalType::VoltronWidth => self.voltron_width.clone(),
            ModalType::LabradorDriveIndexWidth => self.labrador_drive_index_width.clone(),
