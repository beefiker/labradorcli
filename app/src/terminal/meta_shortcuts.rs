...
/// Whether this keystroke should dispatch an action in Labrador despite the
/// [`labrador_ui::event::Event::KeyDown::is_composing`] being true.
///
...
///
/// This function is intended to be used when handling [`labrador_ui::event::Event::KeyDown`] when its
