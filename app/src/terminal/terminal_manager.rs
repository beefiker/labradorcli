...
use super::{
    ...
    view::{create_size_info_for_blocklist, LABRADOR_PROMPT_HEIGHT_LINES},
...
impl labrador_ui::Entity for Box<dyn TerminalManager> {
    type Event = ();
}
...
pub(super) fn compute_block_size(initial_size: Vector2F, ctx: &mut AppContext) -> BlockSize {
    ...
    BlockSize {
        ...
        labrador_prompt_height_lines: LABRADOR_PROMPT_HEIGHT_LINES,
    }
}
