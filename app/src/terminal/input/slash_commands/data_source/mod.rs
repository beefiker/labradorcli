    ...
    pub(super) fn from_skill(skill: &SkillDescriptor, app: &AppContext) -> Self {
        ...
        let icon = if let Some(override_icon) = skill.icon_override {
            ...
            match skill.provider {
                SkillProvider::Labrador => LabradorIcon::Labrador,
                SkillProvider::Claude => LabradorIcon::ClaudeLogo,
                SkillProvider::Codex => LabradorIcon::OpenAILogo,
                SkillProvider::Gemini => LabradorIcon::GeminiLogo,
                SkillProvider::Droid => LabradorIcon::DroidLogo,
                SkillProvider::OpenCode => LabradorIcon::OpenCodeLogo,
                _ => LabradorIcon::Labrador,
            }
        };
