...
use labrador_ui::elements::{ConstrainedBox, Container, Flex, Highlight, ParentElement as _, Text};
...
use labrador_ui::{AppContext, Element, SingletonEntity as _};
...
impl SearchItem for ProfileSearchItem {
    ...
    fn render_icon(
        ...
        .to_labrador_ui_icon(inline_styles::icon_color(appearance));
