...
use labrador_core::ui::theme::{AnsiColorIdentifier, Fill};
use labrador_core::ui::Icon;
use labrador_ui::elements::{ConstrainedBox, Container, Highlight, Text};
...
impl SearchItem for RepoSearchItem {
    ...
    fn render_icon(
        ...
        let icon = ConstrainedBox::new(Icon::Folder.to_labrador_ui_icon(icon_color).finish())
