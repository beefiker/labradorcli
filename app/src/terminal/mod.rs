...
pub use labrador_terminal::shell::{self, ShellLaunchData};
use labrador_ui::geometry::vector::Vector2F;
use labrador_ui::units::{IntoPixels, Lines, Pixels};
...
impl SizeInfo {
    ...
    /// which comes from either a headless Labrador instance or tests.
