...
const EXTENSION_INSTALL_COMMAND: &str =
    "gemini extensions install https://github.com/warpdotdev/gemini-cli-warp --consent";
const EXTENSION_UPDATE_COMMAND: &str = "gemini extensions update gemini-warp";
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| PluginInstructions {
    ...
    steps: &[PluginInstructionStep {
        ...
        command: EXTENSION_UPDATE_COMMAND,
        executable: true,
        link: None,
    }],
...
/// Reads the installed version string for the Labrador extension, if present.
