...
// Keep in sync with the OpenCode plugin package version.
...
static INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        ...
        steps: &[
            ...
            PluginInstructionStep {
                description: "Add the Labrador plugin package to the \"plugin\" array in the top-level JSON object:",
...
static UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        ...
        steps: &[
            ...
            PluginInstructionStep {
                description: "Replace the existing Labrador plugin package entry in the \"plugin\" array with the explicit version:",
