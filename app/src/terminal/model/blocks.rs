...
use labrador_ui::record_trace_event;
...
pub struct BlockList {
    ...
    labrador_prompt_height_lines: f32,

    /// Executor used for spawning threads in the background.
    background_executor: Arc<Background>,

    show_labrador_bootstrap_block: bool,
    ...
    /// to the PTY before labrador_precmd is executed after the first command. `labrador_precmd` is used
...
impl BlockList {
    ...
    pub fn new(
        ...
        event_proxy: ChannelEventListener,
        background_executor: Arc<Background>,
        show_labrador_bootstrap_input: bool,
        show_in_band_command_blocks: bool,
        show_memory_stats: bool,
        honor_ps1: bool,
        is_inverted: bool,
    ...
    /// block.
    /// 3. Create the `BootstrapStage::LabradorInput` block through
    /// `create_labrador_input_block`. From here on, there is always a default
    ...
    fn new_internal(
        ...
        BlockList {
            ...
            labrador_prompt_height_lines: sizes.labrador_prompt_height_lines,
            background_executor,
            show_labrador_bootstrap_block: show_labrador_bootstrap_input,
            show_in_band_command_blocks,
            show_memory_stats,
            honor_ps1,
    ...
    fn initialize(&mut self, restored_blocks: Option<&[SerializedBlockListItem]>) {
        ...
        self.create_labrador_input_block();
    ...
    fn create_labrador_input_block(&mut self) {
        self.create_new_block(
            BlockId::new(),
            BootstrapStage::LabradorInput,
            Default::default(),
            None,
        );
        self.bootstrap_stage = BootstrapStage::LabradorInput;
    }
    ...
    pub fn append_rich_content(
            ...
            && insert_below_long_running_block
        {
            ...
            // until it's started. This is an invariant of the blocklist (see create_labrador_input_block). In this
    ...
    /// `create_labrador_input_block`. For non-block items before then, we should
    ...
    pub fn set_show_bootstrap_block(&mut self, show_bootstrap_block: bool) {
        self.show_labrador_bootstrap_block = show_bootstrap_block;
        self.update_blocks_and_sumtree(
            None,
            None,
    ...
    fn seek_down_to_next_grid(
        ...
        match grid_type {
            GridType::Output => {
                ...
                // vs the next "command" (in the Labrador prompt case), when using the combined grid, rather than
    ...
    fn create_new_block(
        ...
        let mut block = Block::new(
            ...
            bootstrap_stage,
            self.show_labrador_bootstrap_block,
    ...
    fn block_size(&self) -> BlockSize {
        BlockSize {
            ...
            labrador_prompt_height_lines: self.labrador_prompt_height_lines,
        }
    }
    ...
    pub fn bootstrap_block_contents(&self) -> String {
        ...
        for block in self.blocks.iter() {
            match block.bootstrap_stage() {
                BootstrapStage::LabradorInput | BootstrapStage::ScriptExecution => {
    ...
    fn clear_screen(&mut self, mode: ClearMode) {
        ...
        match mode {
            ...
            ClearMode::All => {
                ...
                // Labrador's custom logic for "clear". It's not immediately straightforward because a
                ...
                // quite right with Labrador's custom clear screen logic.
            }
            _ => {}
        }
