...
pub fn block_size() -> BlockSize {
    BlockSize {
        ...
        labrador_prompt_height_lines: 0.6,
    }
}
...
///
/// ```no_run
/// # use labrador::terminal::model::test_utils::TestBlockListBuilder;
...
///
/// ```no_run
/// # use labrador::terminal::event::{BlockType, Event};
/// # use labrador::terminal::event_listener::ChannelEventListener;
/// # use labrador::terminal::model::block::SerializedBlock;
/// # use labrador::terminal::model::test_utils::TestBlockListBuilder;
///
...
impl<'a> TestBlockListBuilder<'a> {
    ...
    pub fn build(self) -> BlockList {
        let mut block_list = BlockList::new(
            ...
            false, /* show_labrador_bootstrap_input */
            false, /* show_labrador_bootstrap_input */
...
///
/// ```no_run
/// # use labrador::terminal::model::test_utils::TestBlockBuilder;
