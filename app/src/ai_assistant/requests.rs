...
/// Tracks the current request status for making Labrador AI requests against server.
...
impl Requests {
    ...
    /// Starts a Labrador AI request against the server with the given request prompt.
