...
// Simple wrapper around warp::run() for Labrador OSS builds.
fn main() -> Result<()> {
    ...
    state = state
        .with_additional_features(&[warp_core::features::FeatureFlag::GitOperationsInCodeReview]);
...
const OSS_INFO_PLIST_PARTS: [&[u8]; 13] = [
    ...
    <string>"#,
    warp_core::channel::APP_NAME_DISPLAY.as_bytes(),
    br#"</string>
    <key>CFBundleExecutable</key>
    <string>"#,
    warp_core::channel::APP_NAME.as_bytes(),
    br#"</string>
