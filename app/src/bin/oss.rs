...
fn main() -> Result<()> {
    let mut state = ChannelState::new(
        Channel::Oss,
        ChannelConfig {
            app_id: AppId::new("dev", "warp", "Dwarf"),
            logfile_name: "dwarf.log".into(),
...
embed_plist::embed_info_plist_bytes!(r#"
    ...
    <array><dict><key>CFBundleURLName</key><string>Dwarf</string><key>CFBundleURLSchemes</key><array><string>dwarf</string></array></dict></array>
