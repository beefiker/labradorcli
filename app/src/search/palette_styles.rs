...
use labrador_ui::elements::{Border, CornerRadius, DropShadow, Radius, ScrollbarWidth};
...
/// https://www.figma.com/design/YjhPAtwuMsy6QnldxfL1DH/Open-files-in-Labrador?node-id=6241-68275&m=dev
