...
use labrador_ui::elements::{Align, ConstrainedBox, Container, Empty};
...
pub fn render_search_item_icon(
    ...
    let icon_element = icon.to_labrador_ui_icon(Fill::Solid(icon_color)).finish();
...
pub mod colors {
    pub const LABRADOR_AI: u32 = 0xF3B911FF;
}
