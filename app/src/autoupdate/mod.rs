...
use labrador_ui::windowing::{self, WindowManager};
use labrador_ui::{
    accessibility::{AccessibilityContent, LabradorA11yRole},
    AppContext,
};
use labrador_ui::{Entity, ModelContext, SingletonEntity, ViewContext};
...
pub enum AutoupdateStage {
    ...
    /// A new version was installed, but Labrador hasn't restarted yet.
    ///
...
/// Relaunch Labrador to apply an update.
///
/// This will:
