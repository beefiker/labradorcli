...
use labrador_ui::{Entity, GetSingletonModelHandle, ModelContext, SingletonEntity, UpdateModel};
...
impl PromptSelection {
    ...
    pub fn separator(&self) -> LabradorPromptSeparator {
        match self {
            PromptSelection::Default => LabradorPromptSeparator::None,
...
impl Prompt {
    ...
    /// Reset to the default Labrador prompt.
    ...
    /// Wehther same line prompt is enabled for Labrador prompt.
    pub fn same_line_prompt_enabled(&self) -> bool {
        self.config.same_line_prompt_enabled
    }

    /// The separator to be used for the Labrador prompt.
    pub fn separator(&self) -> LabradorPromptSeparator {
...
impl PromptConfiguration {
    /// The default Labrador prompt, synthesized from legacy prompt settings.
    ...
    pub fn default_prompt_with_pr_chip_suppressed(suppress_pr_chip: bool) -> Self {
        ...
        Self::from_chips(chips, false, LabradorPromptSeparator::None)
    }
