use labrador_core::{channel::ChannelState, context_flag::ContextFlag, features::FeatureFlag};
...
pub fn sections(ctx: &mut ViewContext<ResourceCenterMainView>) -> Vec<Section> {
    ...
    let maximize_labrador = FeatureSectionData {
        section_name: FeatureSection::MaximizeLabrador,
        items: maximize_labrador_items(ctx),
    };
    sections.push(Section::Feature(maximize_labrador));
    ...
    let advanced_setup = ContentSectionData {
        ...
        items: vec![
            ContentItem {
                ...
                url: "https://docs.labrador.dev/terminal/appearance/prompt",
            ...
            ContentItem {
                ...
                url: "https://docs.labrador.dev/terminal/integrations-and-plugins",
                button_label: "View documentation",
            },
            ContentItem {
                title: format!(
                ...
                url: "https://www.labrador.dev/blog/how-labrador-uses-labrador",
...
fn maximize_labrador_items(ctx: &mut ViewContext<ResourceCenterMainView>) -> Vec<FeatureItem> {
    let mut maximize_labrador_items = vec![];

    maximize_labrador_items.push(FeatureItem::new(
        "Command search",
