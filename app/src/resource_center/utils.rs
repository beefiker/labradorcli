...
// This should always align with documentation: https://docs.labrador.dev/getting-started/keyboard-shortcuts
...
pub const FUNDAMENTALS_KEYBINDINGS: &[&str] = &[
    ...
    "workspace:hide_labrador",
    "workspace:hide_others",
    "workspace:quit_labrador",
    "workspace:minimize",
];
...
pub fn get_additional_keybindings() -> Vec<CommandBinding> {
    vec![
        ...
        CommandBinding::new(
            "workspace:hide_labrador".into(),
            format!("Hide {}", ChannelState::app_name_display()),
