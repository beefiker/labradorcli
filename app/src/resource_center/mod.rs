...
use labrador_ui::{keymap::Keystroke, AppContext, Entity, SingletonEntity};
...
impl TipAction {
    pub fn editable_binding_name(&self) -> &'static str {
        match self {
            ...
            TipAction::LabradorAI => "workspace:toggle_ai_assistant",
            TipAction::OpenLabradorDrive => "workspace:toggle_left_panel",
