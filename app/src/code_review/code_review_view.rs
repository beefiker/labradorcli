...
use crate::{
    ...
    code_review::{
        ...
        telemetry_event::{
            CodeReviewContextDestination, PaneStateChange,
        },
    },
};
...
use super::{
    ...
    comments::{attach_pending_imported_comments, AttachedReviewComment},
...
use labrador_editor::model::CoreEditorModel;
#[cfg(not(target_family = "wasm"))]
use labrador_editor::render::model::AutoScrollMode;
use labrador_editor::{
...
where
    F: Fn(&mut labrador_ui::EventContext<'_>) + 'static,
{
    ...
    .with_tooltip_position(labrador_ui::ui_components::button::ButtonTooltipPosition::BelowLeft)
    .build()
    .on_click(move |ctx: &mut labrador_ui::EventContext<'_>, _, _| {
        on_click(ctx);
    });
...
impl CodeReviewView {
    ...
    pub fn new(
        ...
        let init_project_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("Initialize codebase", NakedTheme)
                .with_size(ButtonSize::Small)
                .with_tooltip("Enables codebase indexing and LABRADOR.md")
    ...
    fn render_placeholder_header(appearance: &Appearance) -> Box<dyn Element> {
        ...
        let loading_icon = Icon::Loading
            .to_labrador_ui_icon(labrador_core::ui::theme::Fill::Solid(
                ...
                Container::new(
                    appearance
                        ...
                        .with_text_and_icon_label(TextAndIcon::new(
                            ...
                            " Retry".to_string(),
                            Icon::Refresh.to_labrador_ui_icon(labrador_core::ui::theme::Fill::Solid(
    ...
    pub fn render_diff_stats(stats: &DiffStats, appearance: &Appearance) -> Box<dyn Element> {
        ...
        counts_row.add_child(
            Container::new(
                ...
                .with_color(
                    labrador_core::ui::theme::Fill::Solid(internal_colors::neutral_6(theme)).into(),
                )
    ...
    fn render_content(
        ...
        let scrollable_diffs = NewScrollable::vertical(
            ...
            labrador_ui::elements::Fill::None,
        )
            ...
            column.add_child(
                Hoverable::new(file_state.sidebar_mouse_state.clone(), |mouse_state| {
                    ...
                    if mouse_state.is_hovered() {
                        container = container.with_background(labrador_core::ui::theme::Fill::Solid(
            ...
            if is_item_being_scrolled && !is_first_item_with_no_scroll {
                ...
                stack.add_positioned_child(
                    ...
                    OffsetPositioning::offset_from_parent(
                        ...
                        labrador_ui::elements::ParentOffsetBounds::ParentByPosition,
                        labrador_ui::elements::ParentAnchor::TopMiddle,
                        labrador_ui::elements::ChildAnchor::TopMiddle,
                    ),
                );
            }
    ...
    fn render_file_stats(&self, file: &FileDiff, appearance: &Appearance) -> Box<dyn Element> {
            ...
            row.add_children([
                ...
                Container::new(
                    Text::new("•", appearance.ui_font_family(), appearance.ui_font_size())
                        .with_style(Properties::default().weight(Weight::Bold))
                        .with_color(
                            labrador_core::ui::theme::Fill::Solid(internal_colors::neutral_6(
                                appearance.theme(),
                            ))
                            .into(),
                        )
        ...
        Container::new(row.finish())
            ...
            .with_vertical_padding(4.)
            .with_border(
                Border::all(1.).with_border_fill(labrador_core::ui::theme::Fill::Solid(
    ...
    fn insert_diff_hunk_as_context(
        &mut self,
        file_path: PathBuf,
        line_range: Range<labrador_editor::render::model::LineCount>,
        ctx: &mut ViewContext<Self>,
    ) {
        let Some(repo_path) = self.repo_path() else {
            return;
    ...
    fn restore_cursor_position(
        ...
        ctx: &mut labrador_ui::ViewContext<CodeEditorView>,
    ) {
    ...
    fn close(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        if !unsaved_file_paths.is_empty() && ChannelState::channel() != Channel::Integration {
            ...
            if cfg!(all(not(target_family = "wasm"), target_os = "macos")) {
                ...
                // Find the workspace to show the Labrador-native modal
