...
impl CommentListView {
        ...
        Hoverable::new(
            ...
            move |mouse_state| {
                ...
                let icon_element = icon
                    .to_labrador_ui_icon(labrador_core::ui::theme::Fill::Solid(text_sub(
                        theme,
                        neutral_1(theme),
                    )))
                    .finish();
        ...
        Container::new(Clipped::new(Shrinkable::new(1., header_row.finish()).finish()).finish())
            ...
            .with_border(
                Border::new(1.)
                    ...
                    .with_border_fill(labrador_core::ui::theme::Fill::Solid(neutral_4(theme))),
            )
            .finish()
    }
    ...
    fn render_send_button(&self, appearance: &Appearance, ctx: &AppContext) -> Box<dyn Element> {
        ...
        let enable_send = match &self.review_destination {
            ...
            ReviewDestination::Labrador => ai_available && has_sendable_comments,
        };
    ...
    fn render(&self, ctx: &AppContext) -> Box<dyn Element> {
        ...
        if self.is_collapsed {
            ...
            Resizable::new(self.view_state.resizable_state.clone(), panel)
                ...
                .with_dragbar_color(labrador_ui::elements::Fill::Solid(
                    labrador_ui::color::ColorU::transparent_black(),
                ))
