...
#[cfg(not(target_family = "wasm"))]
use labrador_editor::content::find::SearchConfig;
#[cfg(not(target_family = "wasm"))]
use labrador_editor::search::Searcher;
use labrador_editor::search::{RestorableSearchResults, SelectedResult};
...
impl CodeReviewFindModel {
    ...
    fn get_editor_searcher(
        ...
        editor_id: EntityId,
        ctx: &AppContext,
    ) -> Option<labrador_ui::ModelHandle<Searcher>> {
