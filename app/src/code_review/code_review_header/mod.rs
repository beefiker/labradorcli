...
use labrador_ui::elements::{Hoverable, ParentElement};
use labrador_ui::platform::Cursor;
use labrador_ui::ui_components::components::{Coords, UiComponent};
use labrador_ui::{
    elements::{
...
impl CodeReviewHeader {
    ...
    fn create_branch_name_element(
        ...
        Container::new(
            labrador_ui::elements::Text::new_inline(
                header_text,
        ...
        let mut button_builder = appearance
            ...
            .with_text_and_icon_label(
                TextAndIcon::new(
                    ...
                    Icon::ReverseLeft.to_labrador_ui_icon(labrador_core::ui::theme::Fill::Solid(
    ...
    fn render_add_diff_set_context_button(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let button = ui_builder
            ...
            .with_text_and_icon_label(TextAndIcon::new(
                TextAndIconAlignment::IconFirst,
                "",
                Icon::Paperclip.to_labrador_ui_icon(labrador_core::ui::theme::Fill::Solid(
            ...
            .with_tooltip_position(labrador_ui::ui_components::button::ButtonTooltipPosition::AboveLeft)
            .build()
            .on_click(|ctx, _, _| {
