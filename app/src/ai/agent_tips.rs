...
use labrador_ui::r#async::SpawnedFutureHandle;
use labrador_ui::{AppContext, Entity, ModelContext, SingletonEntity};
...
static DEFAULT_TIPS: LazyLock<Vec<AgentTip>> = LazyLock::new(|| {
    vec![
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/slash-commands".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/terminal/input/universal-input#input-modes".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/planning".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/terminal/command-palette".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/local-agents/agent-context/using-to-add-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/local-agents/agent-context/blocks-as-context#attaching-blocks-as-context".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/codebase-context".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/agent-profiles-permissions".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/local-agents/interacting-with-agents/conversation-forking".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/terminal/blocks/block-actions#copy-input-output-of-block".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/local-agents/agent-context/images-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/full-terminal-use".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/code/code-review".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/mcp".to_string()),
            binding_name: None,
            action: None,
        ...
        AgentTip {
            ...
            binding_name: None,
            action: None,
            kind: AgentTipKind::LabradorDrive,
        },
        AgentTip {
            description: "`/add-rule` to create a global agent rule.".to_string(),
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/local-agents/interacting-with-agents".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        },
        ...
        AgentTip {
            description: "`/model` to switch the model for the current session.".to_string(),
            link: None,
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/reference/cli".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/rules#project-rules-1".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/local-agents/agent-context/urls-as-context".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::Context,
        },
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/terminal/labradorify".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        AgentTip {
            description: "`/init` to generate a `LABRADOR.md` file and define project rules for the agent.".to_string(),
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/rules".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::SlashCommands,
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/capabilities/full-terminal-use#session-level-approvals".to_string()),
        ...
        AgentTip {
            ...
            link: Some("https://docs.labrador.dev/agent-platform/cloud-agents/managing-cloud-agents#in-app-agent-notifications".to_string()),
            binding_name: None,
            action: None,
            kind: AgentTipKind::General,
        },
        ...
        && AISettings::as_ref(ctx).is_voice_input_enabled(ctx)
    {
        tips.push(AgentTip {
            description: "Hold <keybinding> to speak your prompt directly to the agent."
                .to_string(),
            link: Some(
                "https://docs.labrador.dev/agent-platform/local-agents/interacting-with-agents/voice"
                    .to_string(),
            ),
...
impl AITipModel<AgentTip> {
    ...
    pub fn maybe_refresh_tip(
        ...
        let handle = ctx.spawn(
            async {
                labrador_ui::r#async::Timer::after(Duration::from_secs(60)).await;
            },
            |me, _, _| {
