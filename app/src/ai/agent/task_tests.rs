...
// =============================================================================
// Tests for Labrador docs subagent classification
// =============================================================================

#[test]
fn test_is_labrador_documentation_search_subagent() {
    let parent_id = "parent";
    let subtask_id = "subtask";
    let parent_api_task = create_api_task(
        parent_id,
        vec![create_subagent_tool_call_message(
            ...
            parent_id,
            subtask_id,
            Some(labrador_documentation_search_metadata()),
        )],
    );
    ...
    assert!(subtask.is_labrador_documentation_search_subagent());
