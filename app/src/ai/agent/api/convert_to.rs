...
impl From<UserQueryMode> for labrador_multi_agent_api::UserQueryMode {
    fn from(value: UserQueryMode) -> Self {
        match value {
            UserQueryMode::Normal => labrador_multi_agent_api::UserQueryMode { r#type: None },
            UserQueryMode::Plan => labrador_multi_agent_api::UserQueryMode {
                r#type: Some(labrador_multi_agent_api::user_query_mode::Type::Plan(())),
            },
            UserQueryMode::Orchestrate => labrador_multi_agent_api::UserQueryMode {
                r#type: Some(labrador_multi_agent_api::user_query_mode::Type::Orchestrate(())),
            },
        }
    }
}
    ...
    fn try_from(action_result: AIAgentActionResult) -> Result<Self, Self::Error> {
        let result = match action_result.result {
            ...
            AIAgentActionResultType::OpenCodeReview => Some(
                labrador_multi_agent_api::request::input::tool_call_result::Result::OpenCodeReview(
                    labrador_multi_agent_api::OpenCodeReviewResult {},
                ),
            ),
            ...
            AIAgentActionResultType::InitProject => Some(
                labrador_multi_agent_api::request::input::tool_call_result::Result::InitProject(
                    labrador_multi_agent_api::InitProjectResult {},
                ),
            ),
