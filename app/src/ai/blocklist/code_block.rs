...
use labrador_ui::elements::{ChildView, HighlightedRange, MouseStateHandle};
use labrador_ui::{
    elements::{
...
use labrador_ui::{EventContext, ViewHandle};
...
pub fn render_code_block_with_labrador_text(
