...
use labrador_completer::parsers::simple::decompose_command;
...
impl BlocklistAIPermissions {
    ...
    pub fn permissions_profile_for_id(
        ...
        AIExecutionProfile {
            ...
            autosync_plans_to_labrador_drive: profile_data.autosync_plans_to_labrador_drive,
    ...
    /// Returns whether or not Labrador can auto-read the given files (e.g. for codebase indexing).
