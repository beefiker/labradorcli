...
use uuid::Uuid;
use labrador_multi_agent_api::response_event;
            ...
            Ok(response_event) => {
                if let Some(event_type) = &response_event.r#type {
                    match event_type {
                        ...
                        labrador_multi_agent_api::response_event::Type::ClientActions(_) => {
                            // Mark that we've received client actions
                            self.has_received_client_actions = true;
                        }
                        labrador_multi_agent_api::response_event::Type::Finished(_) => {
