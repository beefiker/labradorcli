...
use labrador_ui::elements::{ChildView, Hoverable, SavePosition};
...
use crate::terminal::view::{TerminalAction, LABRADOR_PROMPT_HEIGHT_LINES};
use crate::ui_components::blended_colors;
use crate::ui_components::icons::Icon;
use crate::view_components::action_button::ActionButton;
use labrador_ui::elements::Icon as ElementIcon;
                ...
                Flex::row()
                    ...
                    .with_child(
                        Container::new(
                            ConstrainedBox::new(
                                Icon::Paperclip
                                    .to_labrador_ui_icon(block_count_color.into())
                                    .finish(),
                            )
...
///
/// This matches the font size used for the Labrador prompt in completed command blocks.
fn prompt_font_size(appearance: &Appearance) -> f32 {
    appearance.monospace_font_size() * LABRADOR_PROMPT_HEIGHT_LINES
}
