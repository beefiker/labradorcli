...
pub type ButtonBuilder = Box<dyn Fn(bool, &labrador_ui::AppContext) -> Button>;
...
impl KeyboardNavigableButtonBuilder {
    pub fn new(
        button_builder: impl Fn(bool, &labrador_ui::AppContext) -> Button + 'static,
...
pub fn simple_navigation_button<A: labrador_ui::Action + Clone + 'static>(
    text_label: String,
...
pub fn rich_navigation_button<A: labrador_ui::Action + Clone + 'static>(
    text_label: String,
