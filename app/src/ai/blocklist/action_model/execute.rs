...
use labrador_core::{execution_mode::AppExecutionMode, features::FeatureFlag};
...
#[cfg(feature = "local_fs")]
use labrador_files::{FileModel, TextFileReadResult};
#[cfg(feature = "local_fs")]
use labrador_util::file::FileLoadError;
#[cfg(feature = "local_fs")]
use labrador_util::file_type::is_buffer_binary;
use labrador_ui::{
...
/// Async sibling of [`labrador_util::file_type::is_file_content_binary`]. Reads
...
/// module so `labrador_util` doesn't need to grow an `async_fs` dependency.
#[cfg(feature = "local_fs")]
