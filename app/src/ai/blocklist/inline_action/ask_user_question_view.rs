...
use labrador_core::ui::theme::{color::internal_colors, LabradorTheme};
use labrador_ui::{
    elements::{
...
struct AskUserQuestionCompletionState {
    label: String,
    status_icon: labrador_ui::elements::Icon,
}
...
impl AskUserQuestionView {
    ...
    fn render_question_body(
        ...
        let scrollable = labrador_ui::elements::NewScrollable::vertical(
