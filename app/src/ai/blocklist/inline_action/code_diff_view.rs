...
use labrador_util::file::FileSaveError;
use labrador_util::path::common_path;
...
impl CodeDiffView {
    ...
    fn create_editor_with_subscriptions(
        ...
        let editor = ctx.add_typed_action_view(move |ctx| {
            ...
            .with_horizontal_scrollbar_appearance(
                labrador_ui::elements::new_scrollable::ScrollableAppearance::new(
    ...
    fn render_scroll_icon_for_inline_banner(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let icon = labrador_ui::elements::Icon::new(
            Icon::ArrowDown.into(),
    ...
    fn render_header_contents(
        ...
        // config and a Labrador config at once) show no badge to avoid misleading attribution.
...
impl View for CodeDiffView {
    ...
    fn keymap_context(&self, _app: &AppContext) -> labrador_ui::keymap::Context {
...
impl BackingView for CodeDiffView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::Standard(view::StandardHeader {
            ...
            title_style: None,
            title_clip_config: labrador_ui::text_layout::ClipConfig::start(),
