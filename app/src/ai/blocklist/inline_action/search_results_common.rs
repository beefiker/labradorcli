...
use labrador_ui::{AppContext, EventContext, SingletonEntity};
...
pub fn render_search_results_header(
    ...
    is_expanded: bool,
    mouse_state: labrador_ui::elements::MouseStateHandle,
    ...
    labrador_ui::elements::Hoverable::new(mouse_state, |_| inner)
...
pub fn render_loading_header(
    text: String,
    icon: labrador_ui::elements::Icon,
    app: &AppContext,
) -> Box<dyn Element> {
    let appearance = Appearance::as_ref(app);
    let theme = appearance.theme();
