...
use labrador_multi_agent_api::response_event::stream_finished::ConversationUsageMetadata;
use labrador_multi_agent_api::{
    client_action::{Action, StartNewConversation},
    response_event::stream_finished::TokenUsage,
};
use labrador_ui::{AppContext, Entity, EntityId, ModelContext, SingletonEntity};
...
impl BlocklistAIHistoryModel {
    ...
    pub fn fork_conversation(
        ...
        let tasks: Vec<labrador_multi_agent_api::Task> = source_conversation
            .all_tasks()
    ...
    pub fn fork_conversation_at_exchange(
        ...
        let truncated_tasks: Vec<labrador_multi_agent_api::Task> = conversation
            .all_tasks()
            .filter_map(|t| {
    ...
    pub fn apply_client_actions(
        &mut self,
        response_stream_id: &ResponseStreamId,
        client_actions: Vec<labrador_multi_agent_api::ClientAction>,
        conversation_id: AIConversationId,
        terminal_view_id: EntityId,
        ctx: &mut ModelContext<Self>,
    ) -> Result<(), UpdateHistoryError> {
    ...
    pub fn insert_forked_conversation_from_tasks(
        &mut self,
        conversation_id: AIConversationId,
        tasks: Vec<labrador_multi_agent_api::Task>,
...
fn update_forked_task_properties(
    tasks: Vec<labrador_multi_agent_api::Task>,
    prefix: &str,
) -> Vec<labrador_multi_agent_api::Task> {
