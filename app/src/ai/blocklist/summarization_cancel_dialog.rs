...
impl View for SummarizationCancelDialog {
    ...
    fn render(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let esc_keystroke = labrador_ui::keymap::Keystroke::parse("escape").expect("Valid keystroke");
        ...
        stack.add_positioned_child(
            dialog_dismiss,
            labrador_ui::elements::OffsetPositioning::offset_from_parent(
                vec2f(0., 0.),
                labrador_ui::elements::ParentOffsetBounds::WindowByPosition,
                labrador_ui::elements::ParentAnchor::Center,
                labrador_ui::elements::ChildAnchor::Center,
            ),
        );
