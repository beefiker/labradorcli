...
use labrador_completer::meta::Spanned;
use labrador_completer::parsers::hir::{Command, Expression, FlagType};
use labrador_completer::parsers::ParsedExpression;
...
cfg_if::cfg_if! {
    if #[cfg(feature = "local_fs")] {
        ...
        use labrador_completer::parsers::hir::ArgType;
    }
}
...
pub fn is_next_command_enabled(app: &labrador_ui::AppContext) -> bool {
...
impl NextCommandModel {
    ...
    fn get_next_command_context(
        ...
        ai_execution_context: LabradorAiExecutionContext,
    ...
    pub fn generate_next_command_suggestion(
        &mut self,
        block_completed: UserBlockCompleted,
        context: LabradorAiExecutionContext,
