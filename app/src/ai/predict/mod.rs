//! This module contains all code relevant to Agent Predict within Labrador.
//!
//! Agent Predict attempts to predict the next action the user will take in Labrador.
