//! This module contains Rust types for the GenerateAMQuerySuggestions server endpoint that
//! serves Agent Mode.
//!
//! These types are manually transposed from the API schema defined in go
//! (server/model/types/generate_am_query_suggestions/(request.go|response.go|common.go)).
//!
