...
use serde::Serialize;
use labrador_cli::{model::ModelCommand, GlobalOptions};
use labrador_ui::{platform::TerminationMode, AppContext, ModelContext, SingletonEntity};
...
impl labrador_ui::Entity for ModelCommandRunner {
    type Event = ();
}
