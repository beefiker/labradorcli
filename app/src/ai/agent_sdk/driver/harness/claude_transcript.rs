...
//!   Claude conversation: the Labrador server conversation id to reuse, the Claude session uuid
...
pub(crate) struct ClaudeResumeInfo {
    /// The Labrador server-side conversation id. The runner stores this instead of calling
