//! General-purpose administrative commands in the Labrador CLI.

use anyhow::{Context, Result};
use serde::Serialize;
use labrador_cli::agent::OutputFormat;
...
impl labrador_ui::Entity for WhoamiRunner {
    type Event = ();
}
...
/// Log out of Labrador using the same logic as the app.
