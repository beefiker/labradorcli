...
use labrador_ui::elements::{ChildView, Element, Empty, ParentElement, Wrap};
use labrador_ui::{AppContext, Entity, TypedActionView, View, ViewContext, ViewHandle};
    ...
    for artifact in artifacts {
        match artifact {
            Artifact::Plan {
                ...
                // Only show plan button if synced to Labrador Drive (has notebook_uid)
