...
use labrador_ui::keymap::{FixedBinding, Keystroke};
use labrador_ui::platform::Cursor;
use labrador_ui::ui_components::components::{Coords, UiComponent, UiComponentStyles};
use labrador_ui::{AppContext, Entity, SingletonEntity, TypedActionView, View, ViewContext};
...
impl AgentTypeSelector {
    ...
    fn render_option(
        ...
        Hoverable::new(mouse_state, move |state| {
            ...
            let avatar_icon = ConstrainedBox::new(icon.to_labrador_ui_icon(icon_color).finish())
