...
use labrador_ui::{AppContext, Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// Tracks and stores notifications for both Labrador agent conversations and other supported
/// cli agent sessions.
...
pub enum AgentManagementEvent {
    /// A Labrador-native conversation needs attention and is not visible in the current window/tab.
