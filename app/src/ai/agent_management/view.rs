...
use labrador_ui::scene::DropShadow;
...
use crate::ai::agent_conversations_model::{
    ...
    ConversationOrTask, CreatedOnFilter, CreatorFilter, HarnessFilter, OwnerFilter, SourceFilter,
    StatusFilter,
};
...
pub fn init(app: &mut AppContext) {
    ...
    app.register_fixed_bindings([FixedBinding::new(
        ...
        labrador_ui::keymap::macros::id!(AgentManagementView::ui_name()),
    )]);
}
...
impl AgentManagementView {
    ...
    fn update_details_panel_for_item(
        ...
        let data = match item_id {
            ManagementCardItemId::Conversation(conversation_id) => {
                ...
                // local conversation (always Labrador Agent).
    ...
    fn render_cloud_loading_icon(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let loading_icon = ConstrainedBox::new(
            Icon::Refresh
                .to_labrador_ui_icon(theme.sub_text_color(theme.surface_1()))
                .finish(),
        )
    ...
    fn render_no_results_view(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        let icon = ConstrainedBox::new(
            Icon::FilterOff
                .to_labrador_ui_icon(appearance.theme().nonactive_ui_text_color())
                .finish(),
        )
        .with_width(24.)
        .with_height(24.)
