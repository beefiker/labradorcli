...
impl TemplatableMCPServerManager {
    ...
    /// Updates a TemplatableMCPServer in Labrador Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Gets all TemplatableMCPServers currently in Labrador Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Creates a new TemplatableMCPServer in Labrador Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    /// Deletes a TemplatableMCPServer from Labrador Drive.
    ///
    /// This is a no-op in WASM, as MCP servers are not supported in WASM.
    ...
    pub fn delete_credentials_from_secure_storage(
        &mut self,
        _sync_id: Uuid,
        _app: &mut labrador_ui::AppContext,
    ) {
