...
const LABRADOR_INDEXING_IGNORE_DESCRIPTION: &str = "To exclude specific files or directories from indexing, add them to the .labradorindexingignore file in your repository directory. These files will still be accessible to AI features, but they won't be included in codebase embeddings.";
...
impl CodeSettingsPageView {
    pub fn new(ctx: &mut ViewContext<CodeSettingsPageView>) -> Self {
        ...
        let page = if FeatureFlag::OpenLabradorNewSettingsModes.is_enabled() {
            #[cfg(feature = "local_fs")]
            {
...
impl SettingsWidget for CodePageWidget {
    ...
    fn render(
        ...
        content.add_child(self.render_settings_subtext(
            global_ai_enabled,
            LABRADOR_INDEXING_IGNORE_DESCRIPTION,
            appearance,
        ));
...
impl CodePageWidget {
        ...
        if !workspace_rule_paths.is_empty() {
            let open_rules_button = ui_builder
                ...
                .with_text_and_icon_label(
                    labrador_ui::ui_components::button::TextAndIcon::new(
                        labrador_ui::ui_components::button::TextAndIconAlignment::IconFirst,
                        "Open project rules",
                        labrador_ui::elements::Icon::new(
                            "bundled/svg/file-code-02.svg",
                            theme.foreground(),
                        ),
                        labrador_ui::elements::MainAxisSize::Min,
                        labrador_ui::elements::MainAxisAlignment::Center,
                ...
                Flex::row()
                    ...
                    .with_child(
                        Container::new(
                            ConstrainedBox::new(
                                Icon::SlashCircle
                                    .to_labrador_ui_icon(ThemeFill::Solid(status_color))
                                    .finish(),
                            )
    ...
    fn render_index_status_parts(
        ...
        let (status_text, status_color) = if index_state.has_pending() {
            ...
            label_row.add_child(
                Container::new(
                    ConstrainedBox::new(
                        status_icon.to_labrador_ui_icon(ThemeFill::Solid(color)).finish(),
                    )
                    .with_width(STATUS_ICON_SIZE)
                    .with_height(STATUS_ICON_SIZE)
                    .finish(),
    ...
    fn render_lsp_server_row(
        ...
        workspace_path: &Path,
        server_type: LSPServerType,
        server_model: Option<&labrador_ui::ModelHandle<LspServerModel>>,
        is_enabled: bool,
        mouse_states: LspServerRowMouseStates,
        appearance: &Appearance,
        app: &AppContext,
    ...
    fn get_lsp_status_info(
        ...
        server_model: Option<&labrador_ui::ModelHandle<LspServerModel>>,
        app: &AppContext,
        theme: &labrador_core::ui::theme::LabradorTheme,
    ) -> (ColorU, &'static str) {
        match server_model {
            Some(model) => {
