...
fn test_worktree_paths_are_kept() {
    let indexed = vec![
        PathBuf::from("/users/alice/.labrador-dev/worktrees/labrador-internal/feature_a"),
        PathBuf::from("/users/alice/.labrador-dev/worktrees/labrador-internal/feature_b"),
