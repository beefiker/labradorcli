...
const HEADER_TEXT: &str = "Invite a friend to Dwarf";
const ANONYMOUS_USER_HEADER_TEXT: &str = "Sign up to participate in Dwarf's referral program";
...
const REWARD_INTRO: &str = "Get exclusive Dwarf goodies when you refer someone*";
