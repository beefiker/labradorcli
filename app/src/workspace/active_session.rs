...
use labrador_ui::{Entity, EntityId, ModelContext, SingletonEntity, WindowId};
...
/// in Labrador from Finder, or when starting from a cloud object). In that case, the `ActiveSession`
