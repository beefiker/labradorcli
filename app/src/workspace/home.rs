...
const WARP_HOME_TITLE: &str = "Welcome to Dwarf on Web";
const WARP_HOME_CONTENT: &str = r#"
Welcome to Dwarf on Web - your browser-based home for Dwarf!
Use Dwarf on Web to:
* Join Shared Sessions
* Create, View, and Edit Dwarf Drive Objects
* Manage your Dwarf Settings

Dwarf on Web can also be used by your teammates and peers who don't have Dwarf downloaded yet to view your shared sessions, notebooks, and workflows."#;
