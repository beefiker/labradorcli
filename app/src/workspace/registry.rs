...
use labrador_ui::{AppContext, Entity, SingletonEntity, WeakViewHandle, WindowId};
...
impl WorkspaceRegistry {
    ...
    pub fn get(
        ...
        window_id: WindowId,
        app: &AppContext,
    ) -> Option<labrador_ui::ViewHandle<Workspace>> {
    ...
    pub fn all_workspaces(
        &self,
        app: &AppContext,
    ) -> Vec<(WindowId, labrador_ui::ViewHandle<Workspace>)> {
        self.workspaces
            .iter()
