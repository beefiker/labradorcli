...
use labrador_ui::accessibility::AccessibilityVerbosity;
use labrador_ui::elements::DropTargetData;
use labrador_ui::keymap::FixedBinding;
use labrador_ui::keymap::{BindingDescription, EditableBinding};
...
pub fn panel_header_corner_radius() -> labrador_ui::elements::CornerRadius {
    labrador_ui::elements::CornerRadius::with_top(labrador_ui::elements::Radius::Pixels(8.))
}
...
pub fn init(app: &mut AppContext) {
    ...
    view::openlabrador_launch_modal::init(app);
    ...
    if ChannelState::enable_debug_features() {
        ...
        #[cfg(debug_assertions)]
        {
            app.register_editable_bindings([
                EditableBinding::new(
                    "workspace:open_openlabrador_launch_modal",
                    "[Debug] Open OpenLabrador Launch Modal",
                    WorkspaceAction::OpenOpenLabradorLaunchModal,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:reset_openlabrador_launch_modal_state",
                    "[Debug] Reset OpenLabrador Launch Modal State",
                    WorkspaceAction::ResetOpenLabradorLaunchModalState,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:install_opencode_labrador_plugin",
                    format!(
                        "[Debug] Install OpenCode {} plugin",
                        ChannelState::app_name_display()
                    ),
                    WorkspaceAction::InstallOpenCodeLabradorPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
                    "workspace:use_local_opencode_labrador_plugin",
                    format!(
                        "[Debug] Use local OpenCode {} plugin (testing only)",
                        ChannelState::app_name_display()
                    ),
                    WorkspaceAction::UseLocalOpenCodeLabradorPlugin,
                )
                .with_context_predicate(id!("Workspace")),
                EditableBinding::new(
    ...
    app.register_editable_bindings([
        ...
        EditableBinding::new(
            ...
            WorkspaceAction::OpenPalette {
                mode: PaletteMode::LabradorDrive,
                source: PaletteSource::Keybinding,
                query: None,
            },
        )
    ...
    app.register_editable_bindings([
        ...
        // two mac menu items for AM vs Labrador AI since they are mutually exclusive.
        .with_custom_action(CustomAction::NewAgentModePane),
    ]);
    ...
    app.register_editable_bindings([
        ...
        .with_context_predicate(
            id!("Workspace") & id!(flags::ENABLE_LABRADOR_DRIVE) & id!(flags::IS_ANY_AI_ENABLED),
        ),
        EditableBinding::new(
        ...
        .with_context_predicate(
            id!("Workspace")
                & id!(flags::ENABLE_LABRADOR_DRIVE)
                & id!("LabradorDrive_BelongsToTeam")
                & id!("IsOnline")
...
fn add_open_setting_pages_as_editable_binding(app: &mut AppContext) {
    ...
    app.register_editable_bindings([
        ...
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace"))
        .with_custom_action(CustomAction::ShowAboutLabrador),
        EditableBinding::new(
        ...
        .with_context_predicate(id!("Workspace")),
        EditableBinding::new(
            "workspace:show_settings_labradorify_page",
            ...
            WorkspaceAction::ShowSettingsPage(SettingsSection::Labradorify),
        )
        .with_group(bindings::BindingGroup::Settings.as_str())
        .with_context_predicate(id!("Workspace")),
        EditableBinding::new(
