...
pub enum LeftPanelEvent {
    ...
    ShowDeleteConfirmationDialog {
        ...
        terminal_view_id: Option<labrador_ui::EntityId>,
    },
}
...
pub struct ToolbeltButtonConfig {
    pub icon: labrador_core::ui::Icon,
    /// Optional icon to use when the given toolbelt option is in an active state.
    pub active_icon: Option<labrador_core::ui::Icon>,
...
impl LeftPanelView {
    ...
    fn get_or_create_global_search_view_for_pane_group(
        &mut self,
        pane_group_id: labrador_ui::EntityId,
        ctx: &mut ViewContext<Self>,
