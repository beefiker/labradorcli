...
use labrador_ui::elements::{Align, Container, Empty, Flex, ParentElement};
...
use labrador_ui::{AppContext, ModelHandle, SingletonEntity, ViewContext};
...
/// Used to show a Labrador-native modal dialog above a [`super::Workspace`]. The first button is [`ButtonVariant::Accent`].
