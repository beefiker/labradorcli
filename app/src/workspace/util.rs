...
pub(super) struct WorkspaceMouseStates {
    ...
    pub(super) labrador_logo: MouseStateHandle,
}
...
pub struct WorkspaceState {
    ...
    pub is_labrador_drive_open: bool,
...
impl WorkspaceState {
    ...
    pub fn close_all_left_panels(&mut self) {
        self.is_labrador_drive_open = false;
...
/// that.
///
/// Note that "active" is not the same as "focused" in Labrador's pane management.
