...
use labrador_ui::text::{point::Point, words::is_default_word_boundary, BufferIndex, TextBuffer};
...
impl TextStyleOperation {
    ...
    /// use labrador_ui::color::ColorU;
    /// use labrador_ui::text_layout::TextStyle;
    /// use labrador::editor::TextStyleOperation;
...
impl Buffer {
    ...
    /// # Example
    /// ```ignore
    /// use labrador_ui::{color::ColorU, App, ModelHandle};
    /// use labrador::Assets;
    /// use labrador::editor::model::buffer::{Buffer, TextStyleOperation, EditOrigin};
