...
use labrador_core::{
    ...
    ui::{
        ...
        theme::{
            ...
            TerminalColors, VerticalGradient, LabradorTheme,
        },
    },
};
...
pub fn dark_theme() -> LabradorTheme {
    LabradorTheme::new(
...
pub fn light_theme() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn dracula() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn solarized_light() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn solarized_dark() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn gruvbox_dark() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn gruvbox_light() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn cyber_wave() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn willow_dream() -> LabradorTheme {
    LabradorTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn fancy_dracula() -> LabradorTheme {
    LabradorTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn phenomenon() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn jellyfish() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn koi() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn leafy() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn marble() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn pink_city() -> LabradorTheme {
...
pub(super) fn snowy() -> LabradorTheme {
    LabradorTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
            ColorU::from_u32(0xFFFFFFFF),
...
pub(super) fn red_rock() -> LabradorTheme {
    LabradorTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn dark_city() -> LabradorTheme {
    LabradorTheme::new(
        Fill::VerticalGradient(VerticalGradient::new(
...
pub(super) fn sent_referral_reward() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn solar_flare() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn adeberry() -> LabradorTheme {
    LabradorTheme::new(
...
pub(super) fn received_referral_reward() -> LabradorTheme {
    LabradorTheme::new(
