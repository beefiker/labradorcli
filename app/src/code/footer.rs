...
use labrador_core::ui::theme::{Fill as ThemeFill, LabradorTheme};
use labrador_core::ui::{appearance::Appearance, Icon};
...
use labrador_ui::{TypedActionView, ViewContext, ViewHandle};
...
impl LSPServerRenderStatus {
    fn to_icon_color(&self, theme: &LabradorTheme) -> ColorU {
        match self {
...
impl CodeFooterView {
    ...
    fn render_tab_config_info_icon(theme: &LabradorTheme) -> Box<dyn Element> {
        Container::new(
            ConstrainedBox::new(
                Icon::Info
                    .to_labrador_ui_icon(theme.active_ui_text_color())
                    .finish(),
            )
            .with_width(12.)
            .with_height(12.)
    ...
    fn render_open_logs_menu_item(
        ...
        Self::render_menu_item(
            ...
            move || {
                Icon::Code1
                    .to_labrador_ui_icon(ThemeFill::Solid(text_color))
                    .finish()
            },
            "Open logs",
    ...
    fn aggregate_indicator_color(&self, theme: &LabradorTheme, app: &AppContext) -> ColorU {
