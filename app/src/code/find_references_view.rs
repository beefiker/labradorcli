...
use labrador_core::ui::{
    appearance::Appearance, icons::Icon as LabradorIcon, theme::color::internal_colors,
};
        ...
        let view = ctx.add_typed_action_view(|ctx| {
            ...
            .with_horizontal_scrollbar_appearance(
                labrador_ui::elements::new_scrollable::ScrollableAppearance::new(
                    labrador_ui::elements::ScrollbarWidth::None,
                    false,
                ),
            );
...
fn render_header(
    ...
    let close_button = Hoverable::new(back_mouse_state, move |state| {
        let close_icon = ConstrainedBox::new(
            labrador_ui::elements::Icon::new(LabradorIcon::X.into(), icon_color).finish(),
        )
        .with_width(16.)
        .with_height(16.)
        .finish();
