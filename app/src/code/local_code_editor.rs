...
use vec1::Vec1;
use labrador_core::{features::FeatureFlag, ui::appearance::Appearance};
use labrador_editor::{
...
use labrador_ui::{platform::SaveFilePickerConfiguration, ModelHandle};
    ...
    fn fetch_definition_for_hover(
        ...
        self.call_goto_definition(
            ...
            move |me, definition_result, ctx| {
                ...
                let on_click: Box<dyn Fn(&mut labrador_ui::AppContext)> = if has_different_definition {
