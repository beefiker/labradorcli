...
use labrador_editor::{content::buffer::InitialBufferState, render::model::LineCount};
use labrador_util::file::{FileLoadError, FileSaveError};
use labrador_ui::{
...
impl View for LocalCodeEditorView {
    ...
    fn render(&self, _app: &AppContext) -> Box<dyn Element> {
        labrador_ui::elements::Empty::new().finish()
    }
}
