    ...
    fn handle_action(&mut self, action: &CodeEditorViewAction, ctx: &mut ViewContext<Self>) {
        ...
        match action {
            ...
            DeleteWordLeft => self.model.update(ctx, |model, ctx| {
                model.delete(TextDirection::Backwards, TextUnit::Word(labrador_ui::text::word_boundaries::WordBoundariesPolicy::Default), false, ctx);
            }),
            DeleteWordRight => self.model.update(ctx, |model, ctx| {
                model.delete(TextDirection::Forwards, TextUnit::Word(labrador_ui::text::word_boundaries::WordBoundariesPolicy::Default), false, ctx);
            }),
            ...
            CutWordLeft => self.model.update(ctx, |model, ctx| {
                model.delete(TextDirection::Backwards, TextUnit::Word(labrador_ui::text::word_boundaries::WordBoundariesPolicy::Default), true, ctx);
            }),
            CutWordRight => self.model.update(ctx, |model, ctx| {
                model.delete(TextDirection::Forwards, TextUnit::Word(labrador_ui::text::word_boundaries::WordBoundariesPolicy::Default), true, ctx);
            }),
...
impl labrador_editor::editor::EditorView for CodeEditorView {
...
impl RichTextAction<CodeEditorView> for CodeEditorViewAction {
    ...
    fn left_mouse_down(
        ...
        // The first mouse down to bring focus to a Labrador window will not have a corresponding mouse up.
