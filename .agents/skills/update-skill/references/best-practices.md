# Best Practices for Labrador Skills
...
1. **Be specific and include key terms**
   - Good: "Add a new feature flag to gate code changes in the Labrador codebase."
   - Avoid: "Helps with features."

2. **Include both what and when**
   - What the skill does: "Write, improve, and run Rust unit tests"
   - When to use it: "in the Labrador Rust codebase"
