...
description: Remove a feature flag after it has been rolled out and stabilized in the Labrador codebase.
---

# remove-feature-flag

Remove a feature flag after it has been rolled out and stabilized in the Labrador codebase.
...
Remove the variant from the `FeatureFlag` enum in `crates/labrador_core/src/features.rs`:
...
```bash
rg "YourFeatureName" app/ crates/labrador_core/
```
