...
use labrador_ui::{AppContext, Entity, ModelContext};
use labrador_ui_extras::user_preferences::UserPreferences;
...
impl PublicPreferences {
    ...
    pub fn reload_from_disk(&self) -> Result<(), labrador_ui_extras::user_preferences::Error> {
        self.0.reload_from_disk()
    }
}

impl labrador_ui::Entity for PublicPreferences {
    type Event = ();
}

impl labrador_ui::SingletonEntity for PublicPreferences {}
...
impl labrador_ui::Entity for PrivatePreferences {
    type Event = ();
}

impl labrador_ui::SingletonEntity for PrivatePreferences {}
...
pub trait Setting {
    ...
    /// Returns whether and how this setting is synced to the cloud via Labrador Drive.
