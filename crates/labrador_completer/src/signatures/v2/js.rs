//! Contains `FromLabradorJs` trait implementations for converting JavaScript command signatures to
//! `labrador_completer::signatures::CommandSignature`s, as well as `IntoLabradorJs` implementations for
...
use labrador_js::{
    ...
    FromLabradorJs, IntoLabradorJs, JsFunctionRegistry,
};
...
impl<'js> FromLabradorJs<'js> for CommandSignature {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        ...
        let command = Command::from_labrador_js(ctx, object.get("command")?, js_function_registry)?;
        Ok(Self { command })
    }
}

impl<'js> FromLabradorJs<'js> for Command {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromLabradorJs<'js> for Argument {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromLabradorJs<'js> for ArgumentValue {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
        ...
        if value.is_object() {
            ...
            if object.contains_key("value")? {
                Ok(ArgumentValue::Suggestion(Suggestion::from_labrador_js(
                    ctx,
                    object.into_value(),
...
impl<'js> FromLabradorJs<'js> for Suggestion {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromLabradorJs<'js> for TemplateType {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
    ) -> rquickjs::Result<Self> {
        let type_string = String::from_labrador_js(ctx, value, js_function_registry)?;
...
impl<'js> FromLabradorJs<'js> for GeneratorFn {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
        ...
        if value.is_object() {
            ...
            let script = GeneratorScript::from_labrador_js(ctx, value, js_function_registry)?;
...
impl<'js> FromLabradorJs<'js> for GeneratorScript {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromLabradorJs<'js> for Opt {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromLabradorJs<'js> for GeneratorResults {
    fn from_labrador_js(
        ctx: rquickjs::Ctx<'js>,
        value: rquickjs::Value<'js>,
        js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> IntoLabradorJs<'js> for GeneratorCompletionContext {
    fn into_labrador_js(self, ctx: rquickjs::Ctx<'js>) -> rquickjs::Result<Value<'js>> {
