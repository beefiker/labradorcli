...
fn test_backtick_escape_char() {
    let source = r#"& "$HOME\Downloads\Labrador` Setup.exe" /SP- /SILENT `t`"#;
    ...
    assert_eq!(
        ...
        [
            ...
            (Token::Literal(r"HOME\Downloads\Labrador"), Span::new(4, 27)),
            (Token::EscapeChar("`"), Span::new(27, 28)),
            (Token::Whitespace(" "), Span::new(28, 29)),
            (Token::Literal("Setup.exe"), Span::new(29, 38)),
            (Token::DoubleQuote, Span::new(38, 39)),
            (Token::Whitespace(" "), Span::new(39, 40)),
            (Token::Literal("/SP-"), Span::new(40, 44)),
            (Token::Whitespace(" "), Span::new(44, 45)),
            (Token::Literal("/SILENT"), Span::new(45, 52)),
            (Token::Whitespace(" "), Span::new(52, 53)),
            (Token::EscapeChar("`"), Span::new(53, 54)),
            (Token::Literal("t"), Span::new(54, 55)),
            (Token::EscapeChar("`"), Span::new(55, 56)),
        ]
    )
}
