use labrador_command_signatures::IconType;
...
#[test]
fn test_split_path() {
    let path = TypedPathBuf::from_unix("/Users/labradoruser");
    let split_path = SplitPath::new(
        path.to_path(),
        "~/Labrador.app",
        Some("/Users/labradoruser"),
        &['/'],
    );
    ...
    assert_eq!(
        ...
        SplitPath {
            ...
            file_name: "Labrador.app".to_owned()
        }
    );

    let split_path = SplitPath::new(
        path.to_path(),
        "Labrador.app/Contents",
        Some("/Users/labradoruser"),
        &['/'],
    );
    assert_eq!(
        split_path,
        SplitPath {
            directory_absolute_path: TypedPathBuf::from("/Users/labradoruser/Labrador.app/"),
            directory_relative_path_name: "Labrador.app/".to_owned(),
    ...
    let split_path = SplitPath::new(
        path.to_path(),
        "Labrador.app/macOS/bin/labrador.o",
        Some("/Users/labradoruser"),
        &['/'],
    );
    assert_eq!(
        ...
        SplitPath {
            directory_absolute_path: TypedPathBuf::from(
                "/Users/labradoruser/Labrador.app/macOS/bin/"
            ),
            directory_relative_path_name: "Labrador.app/macOS/bin/".to_owned(),
            file_name: "labrador.o".to_owned()
        }
    );
}
...
pub fn test_sorted_paths_relative_to() {
    ...
    assert_eq!(
        labrador_ui::r#async::block_on(sorted_paths_relative_to(
            &ParsedToken::empty(),
...
pub fn test_sorted_directories_relative_to() {
    ...
    assert_eq!(
        labrador_ui::r#async::block_on(sorted_directories_relative_to(
            &ParsedToken::empty(),
            MatchStrategy::CaseInsensitive,
            &ctx
        ))
...
pub fn test_sorted_paths_case_insensitive_ordering() {
    ...
    let suggestions: Vec<String> = labrador_ui::r#async::block_on(sorted_paths_relative_to(
        &ParsedToken::empty(),
        MatchStrategy::CaseInsensitive,
        &ctx,
    ))
