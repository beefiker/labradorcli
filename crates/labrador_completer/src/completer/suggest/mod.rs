...
pub enum MatchRequirement {
    ...
    EntireName,
    /// This variant signifies [`labrador_command_signatures::ParserDirectives::flags_match_unique_prefix`]
...
/// This is the public API for using Labrador's completion engine. Note that
