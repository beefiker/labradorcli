...
use labrador_core::ui::theme::{AnsiColor, AnsiColors, Details, Fill, Image, TerminalColors};
...
fn main() -> Result<()> {
    ...
    labrador_logging::init(labrador_logging::LogConfig {
        is_cli: false,
...
fn build_appearance(theme: LabradorTheme, ctx: &mut AppContext) -> Appearance {
    let ui_font_family =
