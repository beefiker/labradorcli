...
impl FreeUserNoAiSlide {
    ...
    fn render_badge(
        ...
        appearance: &Appearance,
        text: String,
        text_color: labrador_ui::color::ColorU,
        border_color: Fill,
    ) -> Box<dyn Element> {
    ...
    fn render_option_button(
        ...
        Hoverable::new(mouse_state, move |_| {
            let icon_el = ConstrainedBox::new(icon.to_labrador_ui_icon(text_fill).finish())
                .with_width(20.)
                .with_height(20.)
                .finish();
            ...
            move |mouse_state| {
                ...
                let label = Flex::row()
                    ...
                    .with_child(
                        ...
                        .with_color(fg_color)
                        .with_style(labrador_ui::fonts::Properties {
                            weight: Weight::Semibold,
                            style: labrador_ui::fonts::Style::Normal,
                        })
