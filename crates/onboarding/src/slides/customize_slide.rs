...
use labrador_core::ui::{appearance::Appearance, theme::color::internal_colors};
use labrador_ui::prelude::Align;
use labrador_ui::{
    elements::{
...
pub struct CustomizeUISlide {
    ...
    chip_labrador_drive_mouse: MouseStateHandle,
    // Buttons
...
impl CustomizeUISlide {
    pub(crate) fn new(
        ...
        Self {
            ...
            chip_labrador_drive_mouse: MouseStateHandle::default(),
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        let title = appearance
            ...
            .paragraph(format!(
                "Customize your {}",
                labrador_core::channel::ChannelState::app_name_display()
            ))
    ...
    fn render_tools_panel_card(
        ...
        if ui.tools_panel_enabled(&intention) {
            ...
            chips.push(ChipSpec {
                label: labrador_core::channel::ChannelState::app_name_with_suffix("Drive"),
                is_enabled: ui.show_labrador_drive,
                mouse_state: self.chip_labrador_drive_mouse.clone(),
                on_click: Box::new(|ctx, _, _| {
                    ctx.dispatch_typed_action(CustomizeSlideAction::ToggleToolsSubSetting {
                        setting: ToolsPanelSubSetting::LabradorDrive,
                    });
                }),
                on_hover: Some(Box::new(|is_hovered, ctx, _, _| {
                    if is_hovered {
    ...
    pub(crate) const VISUAL_IMAGE_PATHS: &'static [&'static str] = &[
        ...
        "async/png/onboarding/agent_intention/customize_labradordrive_vertical.png",
        "async/png/onboarding/agent_intention/customize_labradordrive_horizontal.png",
        ...
        "async/png/onboarding/terminal_intention/terminal_customize_labradordrive_vertical.png",
        "async/png/onboarding/terminal_intention/terminal_customize_labradordrive_horizontal.png",
    ...
    /// When `OpenLabradorNewSettingsModes` is enabled, assets depend on the tab layout setting.
                ...
                if !ui.tools_panel_enabled(&intention) {
                    ...
                    if is_agent {
                        match (chip, vertical) {
                            ...
                            (ToolsPanelSubSetting::LabradorDrive, true) => "async/png/onboarding/agent_intention/customize_labradordrive_vertical.png",
                            (ToolsPanelSubSetting::LabradorDrive, false) => "async/png/onboarding/agent_intention/customize_labradordrive_horizontal.png",
                        }
                    } else {
                        ...
                        match (chip, vertical) {
                            ...
                            (ToolsPanelSubSetting::LabradorDrive, true) => "async/png/onboarding/terminal_intention/terminal_customize_labradordrive_vertical.png",
                            (ToolsPanelSubSetting::LabradorDrive, false) => "async/png/onboarding/terminal_intention/terminal_customize_labradordrive_horizontal.png",
                        }
                    }
                }
            }
            ...
            CustomizeSlideAction::ToggleToolsSubSetting { setting } => {
                ...
                self.onboarding_state
                    .update(ctx, |model, ctx| match setting {
                        ...
                        ToolsPanelSubSetting::LabradorDrive => {
                            let current = model.ui_customization().show_labrador_drive;
                            model.set_show_labrador_drive(!current, ctx);
                        }
                    });
                ctx.notify();
            }
