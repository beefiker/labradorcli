...
use crate::labrador_icon::render_labrador_icon;
...
use labrador_core::ui::{appearance::Appearance, theme::color::internal_colors, Icon};
...
impl IntentionSlide {
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Flex::column()
            ...
            .with_child(
                Container::new(render_labrador_icon(64., 10.))
                    .with_margin_left(-7.)
                    .finish(),
            )
    ...
    fn render_agent_card(
        ...
        let header_row = {
            ...
            for (i, icon) in [Icon::Oz, Icon::ClaudeLogo, Icon::OpenAILogo]
                ...
                .enumerate()
            {
                let el = ConstrainedBox::new(icon.to_labrador_ui_icon(icon_fill).finish())
                    .with_width(16.)
                    .with_height(16.)
                    .finish();
                icon_row = if i == 0 {
        ...
        let checklist = {
            ...
            let mut col = Flex::column()
                ...
                .with_cross_axis_alignment(CrossAxisAlignment::Start);
            for item in items {
                let icon_el = ConstrainedBox::new(Icon::Check.to_labrador_ui_icon(check_fill).finish())
                    .with_width(16.)
                    .with_height(16.)
                    .finish();
    ...
    fn render_bottom_nav(
        ...
        let new_settings_modes = FeatureFlag::OpenLabradorNewSettingsModes.is_enabled();
