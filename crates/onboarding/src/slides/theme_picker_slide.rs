...
use labrador_core::ui::{appearance::Appearance, theme::color::internal_colors, theme::LabradorTheme};
use labrador_ui::{
    elements::{
...
const TOS_URL: &str = "https://www.labrador.dev/terms-of-service";
...
impl ThemePickerSlide {
    ...
    fn render_theme_picker_content(
        ...
        // the login slide (which surfaces the same links) unless Labrador Drive is
        ...
        let labrador_drive_enabled = state.ui_customization().show_labrador_drive;
        if is_terminal
            && !labrador_drive_enabled
            ...
            .with_child(
                ui_builder
                    .span(format!(
                        ...
                        labrador_core::channel::ChannelState::app_name_possessive()
                    ))
                    .with_style(disclaimer_styles)
                    .build()
                    .finish(),
