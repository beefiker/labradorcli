...
use labrador_ui::prelude::{MainAxisAlignment, MainAxisSize, Vector2F};
...
impl ProjectSlide {
        ...
        let (label, variant) = match settings {
            ProjectOnboardingSettings::Project {
                ...
                TextAndIcon::new(
                    ...
                    Icon::Folder.to_labrador_ui_icon(theme.foreground()),
                    MainAxisSize::Max,
            ...
            ProjectOnboardingSettings::NoProject => {
                ...
                let folder_icon =
                    ConstrainedBox::new(Icon::Folder.to_labrador_ui_icon(theme.foreground()).finish())
                        .with_width(16.)
                        .with_height(16.)
                        .finish();
    ...
    fn render_bottom_nav(
        ...
        let theme_picker_last =
            labrador_core::features::FeatureFlag::OpenLabradorNewSettingsModes.is_enabled();
