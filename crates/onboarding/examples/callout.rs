...
use labrador_ui::elements::{Rect, Stack};
use labrador_ui::fonts::{Cache, FamilyId, Weight};
use labrador_ui::platform;
use labrador_ui::{prelude::*, AddWindowOptions, AssetProvider, ModelContext};
...
impl View for RootView {
    ...
    fn render(&self, ctx: &AppContext) -> Box<dyn Element> {
        ...
        let callout = self.callout.render(
            appearance,
            CalloutParams {
                title: "Meet your Labrador input".into(),
