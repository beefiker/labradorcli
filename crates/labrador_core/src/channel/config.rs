...
pub struct ChannelConfig {
    ...
    /// Configuration for talking to Labrador's servers.
    pub server_config: LabradorServerConfig,
...
#[derive(Debug, Deserialize, Serialize)]
pub struct LabradorServerConfig {
    /// The root URL for the standard server pool.
    pub server_root_url: Cow<'static, str>,
    /// The URL for the RTC server, which serves real-time updates for Labrador Drive objects.
...
impl LabradorServerConfig {
    pub fn production() -> Self {
        Self {
            server_root_url: "https://app.labrador.dev".into(),
            rtc_server_url: "wss://rtc.app.labrador.dev/graphql/v2".into(),
            session_sharing_server_url: Some("wss://sessions.app.labrador.dev".into()),
...
pub struct OzConfig {
    ...
    /// to [`LabradorServerConfig::server_root_url`]. This exists so the audience is not overridden
...
impl OzConfig {
    pub fn production() -> Self {
        Self {
            oz_root_url: "https://oz.labrador.dev".into(),
