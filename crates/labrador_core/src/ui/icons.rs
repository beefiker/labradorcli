...
/// Icon enum to be used within the app in place of the labrador_ui::elements::Icon directly. It
...
impl From<Icon> for &'static str {
    fn from(icon: Icon) -> &'static str {
        match icon {
            ...
            Icon::LabradorDrive => "bundled/svg/labrador-drive.svg",
            Icon::Labrador => "bundled/svg/labrador.svg",
            Icon::LabradorLogoLight => "bundled/svg/labrador-logo-light.svg",
            ...
            Icon::LabradorLoading0 => "bundled/svg/labrador-loading-0.svg",
            Icon::LabradorLoading1 => "bundled/svg/labrador-loading-1.svg",
            Icon::LabradorLoading2 => "bundled/svg/labrador-loading-2.svg",
            Icon::LabradorLoading3 => "bundled/svg/labrador-loading-3.svg",
            Icon::LabradorLoading4 => "bundled/svg/labrador-loading-4.svg",
            Icon::LabradorLoading5 => "bundled/svg/labrador-loading-5.svg",
            Icon::LabradorLoading6 => "bundled/svg/labrador-loading-6.svg",
            Icon::LabradorLoading7 => "bundled/svg/labrador-loading-7.svg",
            Icon::LabradorLoading8 => "bundled/svg/labrador-loading-8.svg",
            Icon::LabradorLoading9 => "bundled/svg/labrador-loading-9.svg",
            Icon::LabradorLoading10 => "bundled/svg/labrador-loading-10.svg",
            Icon::LabradorLoading11 => "bundled/svg/labrador-loading-11.svg",
            ...
            // Repointed to the generic agent icon — labrador is local-CLI-only and
            // doesn't ship the cloud-hosted "Oz" brand. All ~18 call sites that
...
impl Icon {
    pub fn to_labrador_ui_icon(self, color: Fill) -> LabradorUiIcon {
        LabradorUiIcon::new(self.into(), color.into_solid())
    }

    pub fn icon_for_key(key: &str) -> Option<LabradorUiIcon> {
        match key {
            "⏎" => Some(Self::CornerDownLeft.to_labrador_ui_icon(Fill::black())),
            _ => None,
        }
    }
}
