...
use super::{AnsiColor, AnsiColorIdentifier, Fill, TerminalColors, LabradorTheme};
...
/// Should not be used directly outside of reusable components. Use color methods on `LabradorTheme` instead.
pub mod internal_colors {
    use labrador_ui::color::ColorU;

    use super::{Fill, LabradorTheme};
    ...
    /// The font color is a mixture of the `labrador_theme`'s background and foreground
    /// colors, and the supplied `background` color.
    fn font_color(labrador_theme: &LabradorTheme, background: impl Into<ColorU>) -> ColorU {
        labrador_theme.font_color(background).into_solid()
    }
    ...
    pub fn accent(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.accent()
    }

    /// Hover state for UI elements like buttons to which we want to call attention.
    /// Allows gradients so shouldn't be used for small elements.
    pub fn accent_hover(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme
            .accent()
            .blend(&labrador_theme.foreground().with_opacity(40))
    }
    ...
    /// Allows gradients so shouldn't be used for small elements.
    #[allow(dead_code)]
    pub fn accent_pressed(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme
            .accent()
            .blend(&labrador_theme.background().with_opacity(30))
    }

    /// The color of most text throughout the UI.
    pub fn text_main(labrador_theme: &LabradorTheme, background: impl Into<ColorU>) -> ColorU {
        coloru_with_opacity(font_color(labrador_theme, background), 90)
    }

    /// The color of subheaders and similar lower priority text.
    pub fn text_sub(labrador_theme: &LabradorTheme, background: impl Into<ColorU>) -> ColorU {
        coloru_with_opacity(font_color(labrador_theme, background), 60)
    }

    /// The color of text elements that are disabled or the lowest priority.
    pub fn text_disabled(labrador_theme: &LabradorTheme, background: impl Into<ColorU>) -> ColorU {
        coloru_with_opacity(font_color(labrador_theme, background), 40)
    }
    ...
    pub fn semantic_text_disabled(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&fg_overlay_5(labrador_theme))
            .into()
    }

    pub fn neutral_1(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(5))
            .into_solid()
    }

    pub fn neutral_2(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(10))
            .into_solid()
    }

    pub fn neutral_3(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(15))
            .into_solid()
    }

    pub fn neutral_4(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(20))
            .into_solid()
    }

    pub fn neutral_5(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(40))
            .into_solid()
    ...
    pub fn neutral_6(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(60))
            .into_solid()
    }

    pub fn neutral_7(labrador_theme: &LabradorTheme) -> ColorU {
        labrador_theme
            .background()
            .blend(&labrador_theme.foreground().with_opacity(90))
            .into_solid()
    }

    pub fn fg_overlay_1(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(5)
    }

    pub fn fg_overlay_2(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(10)
    }

    pub fn fg_overlay_3(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(15)
    }

    pub fn fg_overlay_4(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(20)
    }

    pub fn fg_overlay_5(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(40)
    }

    pub fn fg_overlay_6(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(60)
    }

    pub fn fg_overlay_7(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.foreground().with_opacity(90)
    }

    pub fn accent_bg_strong(labrador_theme: &LabradorTheme) -> Fill {
        Fill::Solid(labrador_theme.background().into_solid())
            .blend(&labrador_theme.accent().with_opacity(60))
    }

    pub fn accent_bg(labrador_theme: &LabradorTheme) -> Fill {
        Fill::Solid(labrador_theme.background().into_solid())
            .blend(&labrador_theme.accent().with_opacity(40))
    }

    pub fn accent_fg_strong(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme
            .foreground()
            .blend(&labrador_theme.accent().with_opacity(60))
    }

    pub fn accent_fg(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme
            .foreground()
            .blend(&labrador_theme.accent().with_opacity(40))
    }

    pub fn accent_overlay_1(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.accent().with_opacity(10)
    }

    pub fn accent_overlay_2(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.accent().with_opacity(25)
    }

    pub fn accent_overlay_3(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.accent().with_opacity(40)
    }

    pub fn accent_overlay_4(labrador_theme: &LabradorTheme) -> Fill {
        labrador_theme.accent().with_opacity(60)
    }
}
