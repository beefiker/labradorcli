...
use super::{builder::UiBuilder, theme::LabradorTheme};
...
impl Appearance {
    ...
    pub fn mock() -> Self {
        ...
        let mock_theme = LabradorTheme::new(
    ...
    pub fn set_theme(&mut self, new_theme: LabradorTheme, ctx: &mut ModelContext<Self>) {
