...
impl ContextFlag {
    ...
    pub fn set_labrador_home_link_only() {
        ...
        disable_flag(Self::LabradorEssentials);
    ...
    pub fn set_labrador_drive_link_only() {
        disable_flag(Self::ForceSidePanelOpen);
        disable_flag(Self::ShowRewardModal);
        disable_flag(Self::HideOpenOnDesktopButton);
        disable_flag(Self::RunWorkflow);
...
impl FromStr for ContextFlag {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "LabradorEssentials" => Ok(Self::LabradorEssentials),
            _ => Err(()),
        }
    }
}
