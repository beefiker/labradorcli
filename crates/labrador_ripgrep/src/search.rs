...
/// The main Labrador process spawns this via the `ripgrep-search` CLI
...
mod process_impl {
    ...
    /// Spawns the Labrador CLI with the `ripgrep-search` subcommand.
    fn spawn_search_process(
        ...
        cmd.arg(labrador_cli::ripgrep_search_subcommand())
