...
/// A type alias for the concrete type stored within a labrador_ui
/// app context, enabling usage such as:
///
/// ```
/// use labrador_ui::{App, SingletonEntity};
/// use labrador_ui_extras::secure_storage;
///
...
/// common scheme is reverse-DNS notation (e.g.: "dev.labrador.Labrador").
#[cfg(not(target_os = "windows"))]
pub fn register(service_name: &str, ctx: &mut labrador_ui::AppContext) {
...
pub fn register_noop(service_name: &str, ctx: &mut labrador_ui::AppContext) {
...
impl labrador_ui::Entity for Model {
    type Event = ();
}

impl labrador_ui::SingletonEntity for Model {}
...
impl AppContextExt for labrador_ui::AppContext {
    fn secure_storage(&self) -> &dyn SecureStorage {
