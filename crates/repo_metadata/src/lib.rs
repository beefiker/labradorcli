//! Repository metadata utilities for Labrador.
//!
...
#[cfg(not(target_family = "wasm"))]
pub fn is_in_repo(path: &str, app: &labrador_ui::AppContext) -> bool {
...
pub fn is_in_repo(_path: &str, _app: &labrador_ui::AppContext) -> bool {
    false
}
