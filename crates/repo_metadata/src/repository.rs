...
use labrador_ui::r#async::{BoxFuture, SpawnedFutureHandle};
#[cfg(feature = "local_fs")]
...
/// Model for tracking a code repository that Labrador is aware of.
                ...
                st.flush_handle = Some(ctx.spawn(
                    async move {
                        ...
                        loop {
                            ...
                            labrador_ui::r#async::Timer::after(wait).await;
