...
use labrador_graphql::managed_secrets::{ManagedSecret, ManagedSecretConfig, ManagedSecretType};

pub use labrador_graphql::queries::task_secrets::ManagedSecretValue;
