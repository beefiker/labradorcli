...
use labrador_graphql::managed_secrets::ManagedSecret;
...
use labrador_graphql::queries::task_secrets::ManagedSecretValue as GqlManagedSecretValue;

/// Singleton model for working with Labrador-managed secrets.
...
impl ManagedSecretManager {
    ...
    /// Get Labrador-managed secrets scoped to the currently-executing task.
    ///
    ...
    pub fn get_task_secrets(
        ...
        async move {
            ...
            let workload_token =
                labrador_isolation_platform::issue_workload_token(Some(Duration::from_mins(5))).await?;
