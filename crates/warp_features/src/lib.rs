...
impl FeatureFlag {
    ...
    pub fn flag_description(&self) -> Option<&'static str> {
        ...
        match self {
            ...
            CloudEnvironments => Some("Enables creating and managing Dwarf Environments via the CLI."),
            CreateEnvironmentSlashCommand => Some("Enables the /create environment slash command for setting up Dwarf Environments with custom configurations."),
            ...
            SettingsFile => Some("Enables configuring Dwarf via a user-editable `settings.toml` file, with hot reload and error reporting for invalid values."),
