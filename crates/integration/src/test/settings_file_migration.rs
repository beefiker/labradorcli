...
use labrador_ui::{async_assert, async_assert_eq, integration::AssertionOutcome, SingletonEntity};
            ...
            wait_until_bootstrapped_single_pane_for_tab(0)
                ...
                .add_named_assertion(
                    ...
                    move |_app, _window_id| {
                        let toml_path = labrador::settings::user_preferences_toml_file_path();
