use labrador::{
    ...
    integration_testing::{
        ...
        notebook::{
            ...
            assert_open_in_labrador_banner_open, create_a_personal_notebook,
...
use labrador_ui::integration::TestStep;
...
pub fn test_open_in_labrador_banner() -> Builder {
    new_builder()
        .with_setup(|utils| {
        ...
        .with_step(
            ...
            .add_assertion(assert_open_in_labrador_banner_open(0, 0)),
        )
        .with_step(
            new_step_with_default_assertions("Click Open in Labrador banner")
                .with_click_on_saved_position_fn(|app, window_id| {
                    let view = terminal_view(app, window_id, 0, 0);
                    format!("open_in_labrador_banner_button_{}", view.id())
                }),
        )
        .with_step(
