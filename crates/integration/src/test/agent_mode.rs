...
use labrador_ui::{async_assert, integration::TestStep, text::SelectionType, Event, SingletonEntity};
...
fn markdown_visuals_fixture_directory() -> String {
    let fixture_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../labrador_ui_core/test_data");
    fixture_dir
        .canonicalize()
