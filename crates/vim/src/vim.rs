use labrador_core::safe_info;
use labrador_ui::{keymap::Keystroke, Entity, ModelContext, ModelHandle, ViewContext};
...
/// This struct is a wrapper around the VimFSA that turns it into a labrador_ui::Entity. We want to keep
/// the VimFSA independent of our UI framework, so anything involving labrador_ui should live here
/// instead.
#[derive(Default)]
pub struct VimModel {
    fsa: VimFSA,
