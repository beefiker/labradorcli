...
impl WatchedFilesRegistry {
    ...
    fn matches(&self, event: &WatchedFileChangeEvent) -> bool {
        ...
        let path_relative = labrador_util::path::normalize_relative_path_for_glob(path_relative);
    ...
    fn pattern_for_relative_pattern(&self, relative_pattern: RelativePattern) -> Option<String> {
        ...
        let prefix = labrador_util::path::normalize_relative_path_for_glob(base_relative);
