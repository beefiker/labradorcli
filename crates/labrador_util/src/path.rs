//! This module contains utilities for dealing with file/directory paths throughout Labrador.
use std::borrow::Cow;
...
/// \return any override shell launch path, reading from the Labrador env variable.
pub fn labrador_shell_path() -> Option<String> {
    // TODO(peter): we ought to tolerate non-Unicode paths here.
    env::var("LABRADOR_SHELL_PATH").ok()
}
...
/// use labrador_util::path::group_roots_by_common_ancestor;
///
