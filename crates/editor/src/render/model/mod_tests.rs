...
use super::{
    ...
    BlockItem, BlockLocation, CellLayout, HiddenBlockConfig, ImageBlockConfig, LaidOutTable,
    ParagraphBlock, RenderState, TableBlockConfig, TableStyle, COMMAND_SPACING,
...
use crate::{
    content::{
        edit::ParsedUrl,
        text::{
            table_cell_offset_maps, BufferBlockStyle, CodeBlockType, FormattedTable,
            FormattedTextFragment,
        },
    },
    render::model::{
        test_utils::{laid_out_paragraph, mock_paragraph, TEST_STYLES},
...
fn test_first_line_bounds() {
    ...
    assert_eq!(
        trailing_block
            ...
            .expect("Bounds should exist"),
        RectF::new(
            vec2f(0., 219., /* 198px y-offset + 14px margin + 7px centering */),
...
// 18:09:15 [INFO] [labrador_editor::render::model] Initial tree:
// -------- 0.00px / 0 characters --------
...
// 18:09:14 [INFO] [labrador_editor::render::model] Initial tree:
// -------- 0.00px / 0 characters --------
...
fn make_test_cell_layout() -> CellLayout {
    CellLayout {
        ...
        line_caret_positions: vec![vec![
            labrador_ui::text_layout::CaretPosition {
...
fn test_link_at_offset_uses_cached_cell_links() {
            ...
            vec![
                ...
                FormattedTextFragment {
                    ...
                    styles: FormattedTextStyles {
                        hyperlink: Some(Hyperlink::Url("https://labrador.dev".into())),
                        ..Default::default()
                    },
                },
            ],
    ...
    table.cell_links = vec![
        vec![
            vec![ParsedUrl::new(1..3, "https://labrador.dev".into())],
            vec![],
        ],
        vec![vec![], vec![]],
    ];
