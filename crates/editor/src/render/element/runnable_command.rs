...
impl RenderableBlock for RenderableRunnableCommand {
    ...
    fn layout(&mut self, _model: &RenderState, ctx: &mut labrador_ui::LayoutContext, app: &AppContext) {
        self.footer.layout(
    ...
    fn paint(&mut self, model: &RenderState, ctx: &mut RenderContext, app: &AppContext) {
        ...
        ctx.paint.scene.start_layer(labrador_ui::ClipBounds::ActiveLayer);
    ...
    fn after_layout(&mut self, ctx: &mut labrador_ui::AfterLayoutContext, app: &labrador_ui::AppContext) {
