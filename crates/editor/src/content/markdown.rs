...
use labrador_ui::{AppContext, ModelContext, ModelHandle};

use string_offset::CharOffset;
use labrador_ui::elements::{ListIndentLevel, ListNumbering};
...
pub enum MarkdownStyle<'a> {
    /// The internal Markdown format used in Labrador Drive. References are normalized, so the Markdown
