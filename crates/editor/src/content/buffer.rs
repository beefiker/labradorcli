...
use labrador_core::{platform::SessionPlatform, safe_error};
...
use labrador_ui::{EntityId, ModelHandle, elements::ListIndentLevel};
use labrador_ui::{
    fonts::Weight,
...
impl Buffer {
    ...
    pub(crate) fn from_markdown(
        ...
        let parse_fn = if labrador_core::features::FeatureFlag::MarkdownTables.is_enabled() {
