...
use diesel::prelude::*;
use labrador_multi_agent_api::{self as api, response_event::stream_finished};
...
pub struct Window {
    ...
    pub labrador_ai_width: Option<f32>,
    pub voltron_width: Option<f32>,
    pub labrador_drive_index_width: Option<f32>,
...
pub struct Block {
    ...
    /// JSON-serialized representation of the Labrador prompt snapshot (Context Chips). Note that this
...
pub struct ModelTokenUsage {
    ...
    pub labrador_tokens: u32,
    #[serde(default)]
    pub byok_tokens: u32,
    #[serde(default)]
    pub labrador_token_usage_by_category: HashMap<TokenUsageCategory, u32>,
    #[serde(default)]
...
impl ModelTokenUsage {
    ...
    pub fn to_proto_labrador_usage(&self) -> Option<(String, stream_finished::ModelTokenUsage)> {
        self.to_proto_usage(self.labrador_tokens, &self.labrador_token_usage_by_category)
    }
    ...
    pub fn to_proto_combined(&self) -> stream_finished::ModelTokenUsage {
        stream_finished::ModelTokenUsage {
            model_id: self.model_id.clone(),
            total_tokens: self.labrador_tokens + self.byok_tokens,
