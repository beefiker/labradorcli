...
pub enum Event {
    ...
    MouseMoved {
        ...
        cmd: bool,
        shift: bool,
        /// Whether this mouse event was initiated by the user or by Labrador synthetically.
        /// We create such synthetic mouse events for certain behaviors behaviors within
        /// Labrador, such as triggering the correct tab to be "hovered" when the user closes
        ...
        /// the old tab (closed) to the new tab (shifted). Certain elements within Labrador,
    ...
    /// Gets fired when user drags a file or folder into Labrador. Note that there could exist
