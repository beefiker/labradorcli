...
/// Events emitted from Labrador on Web to the host JavaScript app.
///
/// These must stay in sync with the host JavaScript event type.
#[derive(Debug, Clone, Serialize)]
#[serde(tag = "kind", rename_all = "SCREAMING_SNAKE_CASE")]
pub enum LabradorEvent {
    LoggedOut,
    SessionJoined,
...
mod ffi {
    ...
    extern "C" {
        ...
        ///
        /// If we need to support more complicated embeddings (like having multiple Labrador Web instances
