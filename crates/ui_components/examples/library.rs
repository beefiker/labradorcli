...
use labrador_core::ui::{Icon, appearance::Appearance, theme::color::internal_colors};
use labrador_ui::{
...
fn main() -> labrador_ui::platform::app::TerminationResult {
    ...
    app_builder.run(move |ctx| {
        ...
        let font_family = labrador_ui::fonts::Cache::handle(ctx).update(ctx, |cache, _ctx| {
        ...
        ctx.add_window(labrador_ui::AddWindowOptions::default(), RootView::new);
    })
}
...
impl View for RootView {
    ...
    fn keymap_context(&self, _: &AppContext) -> labrador_ui::keymap::Context {
        ...
        tooltip::Tooltip.render(
            ...
            tooltip::Params {
                ...
                options: tooltip::Options {
                    keyboard_shortcut: Some(labrador_ui::keymap::Keystroke {
                        ctrl: true,
                        key: "k".to_string(),
                        ..Default::default()
                    }),
                ...
                self.default_button_row.default.render(
                    ...
                    button::Params {
                        ...
                        options: button::Options {
                            keystroke: Some(labrador_ui::keymap::Keystroke {
                                ctrl: true,
                                key: "k".to_string(),
                                ..Default::default()
                            }),
        ...
        self.dialog.render(
            ...
            dialog::Params {
                ...
                options: dialog::Options {
                    ...
                    dismiss_keystroke: Some(labrador_ui::keymap::Keystroke {
                        key: "escape".to_string(),
                        ..Default::default()
                    }),
