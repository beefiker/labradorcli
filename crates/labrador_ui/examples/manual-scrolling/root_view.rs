...
use labrador_ui::elements::new_scrollable::AxisConfiguration;
use labrador_ui::elements::new_scrollable::ClippedAxisConfiguration;
use labrador_ui::elements::new_scrollable::DualAxisConfig;
use labrador_ui::elements::new_scrollable::NewScrollableElement;
use labrador_ui::elements::new_scrollable::ScrollableAppearance;
use labrador_ui::elements::new_scrollable::ScrollableAxis;
use labrador_ui::elements::Axis;

use labrador_ui::elements::ChildView;
use labrador_ui::elements::ClippedScrollStateHandle;
use labrador_ui::elements::NewScrollable;
use labrador_ui::elements::Point;
use labrador_ui::elements::ScrollData;
use labrador_ui::elements::ScrollStateHandle;
use labrador_ui::keymap::FixedBinding;
use labrador_ui::units::Pixels;
use labrador_ui::AppContext;
use labrador_ui::TypedActionView;
use labrador_ui::ViewHandle;
use labrador_ui::{
...
impl Element for ScrollableElement {
    fn layout(
        &mut self,
        constraint: labrador_ui::SizeConstraint,
        _: &mut labrador_ui::LayoutContext,
        _: &AppContext,
    ) -> Vector2F {
        let size = vec2f(
    ...
    fn after_layout(&mut self, _: &mut labrador_ui::AfterLayoutContext, _: &AppContext) {}

    fn paint(&mut self, origin: Vector2F, ctx: &mut labrador_ui::PaintContext, _app: &AppContext) {
    ...
    fn dispatch_event(
        &mut self,
        _: &labrador_ui::event::DispatchedEvent,
        _: &mut labrador_ui::EventContext,
        _: &AppContext,
    ) -> bool {
        false
    }
...
impl NewScrollableElement for ScrollableElement {
    ...
    fn scroll(&mut self, delta: labrador_ui::units::Pixels, axis: Axis, ctx: &mut labrador_ui::EventContext) {
        match axis {
            Axis::Horizontal => (),
            Axis::Vertical => {
