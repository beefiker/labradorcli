...
impl View for RootView {
    ...
    fn render(&self, _: &AppContext) -> Box<dyn Element> {
        ...
        let top_panel = Container::new(
            ...
            .with_dragbar_color(labrador_ui::elements::Fill::Solid(ColorU::new(0, 255, 255, 200)))
        ...
        let left_panel = Container::new(
            ...
            .with_dragbar_color(labrador_ui::elements::Fill::Solid(ColorU::new(255, 255, 0, 200)))
            .on_resize(move |ctx, _| {
                ctx.notify();
            })
            .on_start_resizing(|_, _| {
