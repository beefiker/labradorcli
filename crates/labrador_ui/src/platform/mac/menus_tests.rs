//! Memory-behavior repros for APP-4154 batch 1.C (labrador_ui-platform-nsstring).
//!
...
use labrador_ui_core::platform::menu::{MenuItem, MenuItemPropertyChanges};
    ...
    unsafe {
        ...
        for _ in 0..APPLY_CHANGES_ITERS {
            let changes = MenuItemPropertyChanges {
                name: Some("Labrador Menu Item".to_string()),
