...
pub(crate) struct WindowManager {
    ...
    /// We assume this won't change throughout the life of the Labrador process.
...
fn create_window(
    ...
    #[cfg(windows)]
    {
        // WARNING: Do not use [`WindowAttributes::with_no_redirection_bitmap`];
        // it has caused Windows rendering regressions.
