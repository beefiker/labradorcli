...
pub enum Experiment {
    ...
    #[cynic(rename = "TMUX_SSH_WARPIFICATION_CONTROL")]
    TmuxSshLabradorificationControl,
    #[cynic(rename = "TMUX_SSH_WARPIFICATION_EXPERIMENT")]
    TmuxSshLabradorificationExperiment,
