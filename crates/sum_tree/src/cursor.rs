    ...
    U: Dimension<'a, T::Summary>,
{
        ...
        D: Dimension<'a, T::Summary>,
    {
        ...
        //
        // Note that we don't need special handling for floating point consistency in the
        // already seeked case - it's only an issue when descending the tree, not when
        // unwinding the stack.
        if self.did_seek {
                    ...
                    Node::Internal {
                            ...
                            child_trees.iter().zip(child_summaries).enumerate()
                        {
                            ...
                            if at_last_item {
                                ...
                                // This handles floating point consistency at the end of a summary.
