...
/// - A **simple skill name** - searched across skill directories with precedence (`.agents/skills/`, `.labrador/skills/`, `.claude/skills/`, `.codex/skills/`)
...
/// ```ignore
/// code-review                              // searches .agents/skills/, .labrador/skills/, .claude/skills/, .codex/skills/
/// sample-internal:code-review              // searches in "sample-internal" repo
/// example-org/sample-internal:code-review  // searches in specific org/repo
/// ```
///
/// Full paths (resolved directly, no precedence):
/// ```ignore
/// .agents/skills/my-skill/SKILL.md                              // directly resolves this path
/// sample-server:.claude/skills/deploy/SKILL.md                       // exact path in "sample-server" repo
/// example-org/sample-internal:.claude/skills/code-review/SKILL.md    // exact path in org/repo
/// ```
#[derive(Debug, Clone, PartialEq, Eq)]
pub struct SkillSpec {
    /// Optional GitHub organization (e.g., "example-org" in "example-org/sample-internal:code-review")
    pub org: Option<String>,
    /// Optional repository name (e.g., "sample-internal")
    pub repo: Option<String>,
    /// The skill identifier - either a simple name or a full path to SKILL.md.
    ///
    /// - **Simple name** (e.g., `"code-review"`): Searched across `.agents/skills/`, `.labrador/skills/`, `.claude/skills/`, `.codex/skills/`
...
impl SkillSpec {
    ...
    /// skill directories in precedence order (`.agents/skills/`, `.labrador/skills/`, `.claude/skills/`, `.codex/skills/`).
    ///
