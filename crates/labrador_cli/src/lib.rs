...
pub const API_KEY_ENV: &str = "LABRADOR_API_KEY";
pub const OUTPUT_FORMAT_ENV: &str = "LABRADOR_OUTPUT_FORMAT";
pub const SERVER_ROOT_URL_OVERRIDE_ENV: &str = "LABRADOR_SERVER_ROOT_URL";
pub const WS_SERVER_URL_OVERRIDE_ENV: &str = "LABRADOR_WS_SERVER_URL";
pub const SESSION_SHARING_SERVER_URL_OVERRIDE_ENV: &str = "LABRADOR_SESSION_SHARING_SERVER_URL";
...
pub struct GlobalOptions {
    ...
    #[arg(long = "api-key", global = true, env = "LABRADOR_API_KEY", hide = true)]
...
#[command(
    name = labrador_core::channel::APP_NAME,
    display_name = labrador_core::channel::APP_NAME_DISPLAY,
    about = labrador_core::channel::APP_CLI_ABOUT
)]
...
pub struct Args {
    ...
    #[arg(
        ...
        global = true,
        hide = true,
        env = "LABRADOR_SESSION_SHARING_SERVER_URL"
    )]
    ...
    pub fn from_env() -> Self {
        cfg_if::cfg_if! {
            ...
            if #[cfg(target_family = "wasm")] {
                ...
                // `labrador environment` should not return help text)
...
pub enum Command {
    ...
    ///     source <(path/to/labrador completions bash)
    ///
    /// For zsh, add the following to ~/.zshrc:
    ///     source <(path/to/labrador completions zsh)
    ///
    /// For fish, add the following to ~/.config/fish/config.fish:
    ///     path/to/labrador completions fish | source
    ///
    /// For Powershell, add the following to $PROFILE:
    ///     path\to\labrador | Out-String | Invoke-Expression
    ///
