...
pub trait FromLabradorJs<'js>: Sized {
    fn from_labrador_js(
        ctx: Ctx<'js>,
        value: Value<'js>,
...
pub trait IntoLabradorJs<'js>: Sized {
    fn into_labrador_js(self, ctx: Ctx<'js>) -> rquickjs::Result<Value<'js>>;
}

impl<'js, T> FromLabradorJs<'js> for Vec<T>
where
    T: FromLabradorJs<'js>,
{
    fn from_labrador_js(
        ...
        if value.is_array() {
            ...
            Ok(values
                .into_iter()
                .flat_map(|value| T::from_labrador_js(ctx, value, js_function_registry).ok())
                .collect())
        } else {
...
impl<'js> FromLabradorJs<'js> for String {
    fn from_labrador_js(
        ctx: Ctx<'js>,
        value: Value<'js>,
...
impl<'js> FromLabradorJs<'js> for bool {
    fn from_labrador_js(
        ctx: Ctx<'js>,
        value: Value<'js>,
        _js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> FromLabradorJs<'js> for i32 {
    fn from_labrador_js(
        ctx: Ctx<'js>,
        value: Value<'js>,
        _js_function_registry: &mut JsFunctionRegistry,
...
impl<'js> IntoLabradorJs<'js> for String {
    fn into_labrador_js(self, ctx: Ctx<'js>) -> rquickjs::Result<Value<'js>> {
        self.into_js(ctx)
    }
}

impl<'js> IntoLabradorJs<'js> for Vec<String> {
    fn into_labrador_js(self, ctx: Ctx<'js>) -> rquickjs::Result<Value<'js>> {
        self.into_js(ctx)
    }
}
